...
#ifdef __QNXNTO__
// Must specify full path to firmware
#define INTEL_IPU4_CPD_FIRMWARE_B0  "/lib/firmware/intel/ipu4/ipu4_cpd_b0.bin"
#else
...
#ifdef __QNXNTO__
// Initialization is done through function calls instead of device registration
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/capture/intel-ipu4/driver/intel-ipu4-drv/intel-ipu4.h $ $Rev: 838597 $")
#endif
