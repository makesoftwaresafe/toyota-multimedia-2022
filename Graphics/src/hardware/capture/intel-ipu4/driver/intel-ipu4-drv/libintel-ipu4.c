...
#ifdef __QNXNTO__
		// Do not wait for timeout if a reset is active
		if (qnxw_is_ipu4_reset_active()) {
			rval = 0;
			break;
		}
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/capture/intel-ipu4/driver/intel-ipu4-drv/libintel-ipu4.c $ $Rev: 871034 $")
#endif
