...
#ifdef __QNXNTO__
// Make this public for QNX such that we can set it in our code
extern bool secure_mode_enable;
...
#ifdef __QNXNTO__
// Start/stop our ISR thread
int intel_ipu4_buttress_start_isr(struct intel_ipu4_device* isp);
int intel_ipu4_buttress_stop_isr(struct intel_ipu4_device* isp);
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/capture/intel-ipu4/driver/intel-ipu4-drv/intel-ipu4-buttress.h $ $Rev: 838597 $")
#endif
