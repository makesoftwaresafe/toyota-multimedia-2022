...
#else
	dev_dbg(dev, "process_group_light.param_buf_id %" PRIu64,
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/capture/intel-ipu4/driver/intel-ipu4-drv/intel-ipu4-isys-fw-msgs.c $ $Rev: 836043 $")
#endif
