...
{
#ifdef __QNXNTO__
	deinit_waitqueue_head(&fence->wait);
#endif /* __QNXNTO__ */
...
static void dma_i915_sw_fence_wake(struct dma_fence *dma, struct dma_fence_cb *data)
{
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/i915/i915_sw_fence.c $ $Rev: 864420 $")
#endif
