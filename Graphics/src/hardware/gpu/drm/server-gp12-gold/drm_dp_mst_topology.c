...
#ifdef __QNXNTO__
	deinit_waitqueue_head(&mgr->tx_waitq);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/drm_dp_mst_topology.c $ $Rev: 836322 $")
#endif
