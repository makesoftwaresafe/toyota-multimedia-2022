...
#else
	BUG();
	qnx_error("this function should have never been called inside drm-intel");
	abort();
#endif /* __QNXNTO__ */
	if (gtt_table == NULL)
		return -ENOMEM;
...
static int find_gmch(u16 device)
{
	...
	if (gmch_device && PCI_LNX_FUNC(gmch_device->devfn) != 0) {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/qnx/intel-gtt.c $ $Rev: 845340 $")
#endif
