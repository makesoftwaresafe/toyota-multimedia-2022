...
void backlight_class_exit(void)
{
	class_destroy(backlight_class);
}

int backlight_class_init(void)
{
 ...
 */
module_init(backlight_class_init);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/qnx/qbacklight.c $ $Rev: 844871 $")
#endif
