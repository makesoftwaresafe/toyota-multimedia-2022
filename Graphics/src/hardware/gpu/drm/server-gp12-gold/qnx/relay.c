 ...
 */
#ifdef __QNXNTO__
/* Linux kernel 4.1 has a bit different API */
static int relay_buf_fault(struct vm_area_struct *area, struct vm_fault *vmf)
#else
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/qnx/relay.c $ $Rev: 836322 $")
#endif
