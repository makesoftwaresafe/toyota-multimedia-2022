...
static inline int __irq_alloc_descs(int irq, unsigned int from, unsigned int cnt, int node,
		struct module *owner)
{
	/* MG_TODO: we don't need this function, since we maintain array statically in interrupt.c */
}
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/include/linux/irq.h $ $Rev: 836322 $")
#endif
