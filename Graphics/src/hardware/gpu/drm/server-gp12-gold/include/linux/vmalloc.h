...
{
	return __vmalloc(size, GFP_KERNEL | GFP_DMA32, PAGE_KERNEL);
}
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/include/linux/vmalloc.h $ $Rev: 840419 $")
#endif
