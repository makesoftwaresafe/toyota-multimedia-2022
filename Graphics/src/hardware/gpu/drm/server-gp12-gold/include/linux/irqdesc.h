...
#else /* __QNXNTO__ */
struct irq_desc {
	// dev_id is our lookup key.  It's also passed to the handler.
	void *dev_id;
	struct irq_common_data irq_common_data;
	struct irq_data irq_data;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/include/linux/irqdesc.h $ $Rev: 844609 $")
#endif
