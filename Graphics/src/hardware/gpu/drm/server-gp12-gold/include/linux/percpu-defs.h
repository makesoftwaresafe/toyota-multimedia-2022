...
#define __this_cpu_and(pcp, val) (pcp &= val)
#define __this_cpu_or(pcp, val) (pcp |= val)
...
#define this_cpu_cmpxchg(pcp, oval, nval) cmpxchg(&pcp, oval, nval)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/include/linux/percpu-defs.h $ $Rev: 843003 $")
#endif
