			  ...
			  struct seq_file *m)
{
	...
	seq_printf(m, "%2d (%2d) %08llx %pad %p %zu",
			...
			(unsigned long long)off, &cma_obj->paddr, cma_obj->vaddr, obj->size);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/drm_gem_cma_helper.c $ $Rev: 836322 $")
#endif
