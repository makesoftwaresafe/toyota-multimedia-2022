...
#ifdef __QNXNTO__
	spin_destroy(&dev->mode_config.connector_list_lock);
#endif /* __QNXNTO__ */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/drm_mode_config.c $ $Rev: 836322 $")
#endif
