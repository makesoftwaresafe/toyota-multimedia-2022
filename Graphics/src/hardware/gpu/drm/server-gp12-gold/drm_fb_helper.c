...
#ifdef __QNXNTO__
	spin_destroy(&fb_helper->dirty_lock);
#endif /* __QNXNTO__ */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/denso-jp-hv-ivi/hardware/gpu/drm/server-gp12-gold/drm_fb_helper.c $ $Rev: 841111 $")
#endif
