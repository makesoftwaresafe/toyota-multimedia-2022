...
{
    EXPECT_EQ(DLT_RETURN_ERROR, dlt_logstorage_update_all_contexts(NULL, NULL, NULL, 0, 0, NULL, 0));
}
...
{
    EXPECT_EQ(DLT_RETURN_ERROR, dlt_logstorage_update_context(NULL, NULL, NULL, NULL, NULL, 0, 0));
}
...
{
    EXPECT_EQ(DLT_RETURN_ERROR, dlt_logstorage_update_context_loglevel(NULL, NULL, NULL, 0, 0));
}
...
TEST(t_dlt_daemon_logstorage_setup_internal_storage, normal)
{
    ...
    daemon.storage_handle->config_list = NULL;
    EXPECT_EQ(DLT_RETURN_OK, dlt_daemon_logstorage_setup_internal_storage(&daemon, &daemon_local, path, 1, 0));
}

TEST(t_dlt_daemon_logstorage_setup_internal_storage, null)
{
    EXPECT_EQ(DLT_RETURN_ERROR, dlt_daemon_logstorage_setup_internal_storage(NULL, NULL, NULL, 0, 0));
}
