...
/**
 * provide the registered appid
 * This function has to be called before registering an application.
 * @param character pointer of minimum four bytes to provide appid registered
 */
