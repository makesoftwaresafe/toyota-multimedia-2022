/***************************************************
 *  ipp_iap2_prevchapter.c                          
 *  Created on: 2014/01/17 17:55:32                 
 *  Implementation of the Class ipp_iap2_prevchapter
...
S32 ippiAP2PrevChapter( IPOD_PLAYER_CORE_IPODCTRL_CFG       *iPodCtrlCfg,
                        IPOD_PLAYER_CORE_IAP2_EXECUTE_PARAM *param)
{
    S32 rc = IPOD_PLAYER_ERROR;
    iAP2Device_t* iap2Device = NULL;
    ReportTable_t   reports_tbl[] = {   IAP2_PREVIOUS_TR_REPORT,
                                        IAP2_RELEASE_REPORT,
