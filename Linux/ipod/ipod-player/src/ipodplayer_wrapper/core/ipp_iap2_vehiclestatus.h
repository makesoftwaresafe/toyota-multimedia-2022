...
#ifndef __ipp_iap2_vehiclestatus_h__
#define __ipp_iap2_vehiclestatus_h__
...
S32 ippiAP2SetVehicleStatus( IPOD_PLAYER_CORE_IPODCTRL_CFG *iPodCtrlCfg, IPOD_PLAYER_CORE_IAP2_EXECUTE_PARAM *param);

#endif /* ifndef __ipp_iap2_vehiclestatus_h__ */
