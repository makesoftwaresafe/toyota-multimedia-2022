/****************************************************
 *  ipp_iap2_changeshufle.c                          
 *  Created on: 2014/02/21 17:00:00                  
 *  Implementation of the Class ipp_iap2_changeshufle
...
S32 ippiAP2ChangeShuffle(   IPOD_PLAYER_CORE_IPODCTRL_CFG       *iPodCtrlCfg,
                            IPOD_PLAYER_CORE_IAP2_EXECUTE_PARAM *param)
{
    S32 rc = IPOD_PLAYER_ERROR;
    iAP2Device_t* iap2Device = NULL;
    ReportTable_t   reports_tbl[] = {   IAP2_RANDOM_PLAY_REPORT | IAP2_RESTORE_FLAG,
