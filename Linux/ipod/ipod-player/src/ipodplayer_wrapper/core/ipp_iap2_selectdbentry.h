...
#ifndef IPP_IAP2_SELECTDBENTRY_H
#define IPP_IAP2_SELECTDBENTRY_H
...
S32 ippiAP2SelectDBEntry(IPOD_PLAYER_CORE_IPODCTRL_CFG *iPodCtrlCfg, IPOD_PLAYER_CORE_IAP2_EXECUTE_PARAM *param);

#endif /* IPP_IAP2_SELECTDBENTRY_H */
