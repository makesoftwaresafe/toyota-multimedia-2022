/*
 * iap2_vehicle_status_test.h
 */

#ifndef IAP2_VEHICELE_STATUS_TEST_H
#define IAP2_VEHICELE_STATUS_TEST_H
...
typedef struct
{
    BOOL iAP2VehicleNightMode;
    BOOL iAP2VehicleRange;
    BOOL iAP2VehicleInsideTemperature;
...
#endif /* IAP2_VEHICELE_STATUS_TEST_H */
