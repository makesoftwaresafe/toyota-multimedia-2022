    ...
    if(rc == IAP2_OK)
       ...
       if(rc == IAP2_OK)
       {
        ...
        if(rc == IAP2_OK)
        {
            ...
            U16 RG_Max_Guidance_Capacity[] = {20};
            U16 RG_Max_Guidance_Description_Length = {256};
       ...
       if(rc == IAP2_OK)
       {
           ...
           if(rc == IAP2_OK)
           {
               U8  VehicleMapsDisplayName[]                 = {"MapsDisplayName"};
               accInfo->iAP2VehicleInformationComponent->iAP2MapsDisplayName = (U8*)strndup( (const char*)VehicleMapsDisplayName, strnlen((const char*)VehicleMapsDisplayName, STRING_MAX) );
