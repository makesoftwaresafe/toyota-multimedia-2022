...
LOCAL S32 iap2TestStartAppDiscoveryUpdates(S32 mq_fd, iAP2Device_t* iap2Device)
{
    ...
    IAP2TESTDLTLOG(DLT_LOG_INFO,"Testing Start App discovery ");
    ...
    if (rc == IAP2_OK)
    {
        ...
        if(rc  == IAP2_OK)
        {
            ...
            iap2device = iAP2InitDeviceStructure(iAP2InitParameter);
                printf(" %u ms  iAP2InitDeviceStructure = 0x%p \n", iap2CurrTimeMs(), iap2device);
            IAP2TESTDLTLOG(DLT_LOG_INFO, "iAP2InitDeviceStructure rc = %p ", iap2device);
        }
...
LOCAL void iap2RootDaemonProcess(void* exinf)
{
    ...
    if(((g_iap2UserConfig.iAP2TransportType == iAP2USBHOSTMODE)||(g_iap2UserConfig.iAP2TransportType == iAP2MULTIHOSTMODE))&&(rc == IAP2_OK))
    {
