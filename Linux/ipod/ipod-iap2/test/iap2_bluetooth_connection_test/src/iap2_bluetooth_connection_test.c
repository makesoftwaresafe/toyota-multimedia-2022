/*
 * iap2_bluetooth_connection_test.c
 */
...
#include "iap2_bluetooth_connection_test.h"
...
/* test functions */
LOCAL S32 iap2TestBluetoothComponentInfo(S32 mq_fd, iAP2Device_t* iap2Device);
...
LOCAL S32 iap2TestBluetoothComponentInfo(S32 mq_fd, iAP2Device_t* iap2Device)
{
    S32 rc = IAP2_CTL_ERROR;
    U16 i = 0;
    iAP2BluetoothComponentInformationParameter theiAP2BluetoothComponentInformationParameter;

    /* temporary fix for compiler warnings */
    iap2Device = iap2Device;

    memset(&theiAP2BluetoothComponentInformationParameter, 0, sizeof(iAP2BluetoothComponentInformationParameter));

    theiAP2BluetoothComponentInformationParameter.iAP2BluetoothComponentStatus = calloc(IAP2_BT_MAC_ADDRESS_CNT, sizeof(iAP2BluetoothComponentStatus));
    if(theiAP2BluetoothComponentInformationParameter.iAP2BluetoothComponentStatus != NULL)
    {
        for(i=0; i<IAP2_BT_MAC_ADDRESS_CNT; i++)
        {
            theiAP2BluetoothComponentInformationParameter.iAP2BluetoothComponentStatus[i].iAP2BTComponentIdentifier = calloc(1, sizeof(U16));
            *(theiAP2BluetoothComponentInformationParameter.iAP2BluetoothComponentStatus[i].iAP2BTComponentIdentifier) = IAP2_BT_TRANS_COMP_ID+i;
            theiAP2BluetoothComponentInformationParameter.iAP2BluetoothComponentStatus[i].iAP2BTComponentIdentifier_count++;

            theiAP2BluetoothComponentInformationParameter.iAP2BluetoothComponentStatus[i].iAP2BTComponentEnabled = calloc(1, sizeof(U8));
            if(theiAP2BluetoothComponentInformationParameter.iAP2BluetoothComponentStatus[i].iAP2BTComponentEnabled != NULL)
            {
                theiAP2BluetoothComponentInformationParameter.iAP2BluetoothComponentStatus[i].iAP2BTComponentEnabled_count++;
                *(theiAP2BluetoothComponentInformationParameter.iAP2BluetoothComponentStatus[i].iAP2BTComponentEnabled)  = 1;
            }
            theiAP2BluetoothComponentInformationParameter.iAP2BluetoothComponentStatus_count++;
        }

        rc = iap2SendMqRecvAck(mq_fd, g_iap2TestDevice.mqAppTskFd,
                                MQ_CMD_BT_COMP_INFO,
                                &theiAP2BluetoothComponentInformationParameter, sizeof(iAP2BluetoothComponentInformationParameter));

        iAP2FreeiAP2BluetoothComponentInformationParameter(&theiAP2BluetoothComponentInformationParameter);
    }
    return rc;

}

LOCAL S32 iap2TestStartBluetoothConnectionUpdates(S32 mq_fd, iAP2Device_t* iap2Device)
{
    S32 rc = IAP2_CTL_ERROR;
    U16 i = 0;
    iAP2StartBluetoothConnectionUpdatesParameter theiAP2StartBluetoothConnectionUpdatesParameter;

    /* temporary fix for compiler warnings */
    iap2Device = iap2Device;

    memset(&theiAP2StartBluetoothConnectionUpdatesParameter, 0, sizeof(iAP2StartBluetoothConnectionUpdatesParameter));

    theiAP2StartBluetoothConnectionUpdatesParameter.iAP2BluetoothTransportComponentIdentifier = calloc(IAP2_BT_MAC_ADDRESS_CNT, sizeof(U16));
    if(theiAP2StartBluetoothConnectionUpdatesParameter.iAP2BluetoothTransportComponentIdentifier != NULL)
    {
        for(i=0; i<IAP2_BT_MAC_ADDRESS_CNT; i++)
        {
            memcpy(&theiAP2StartBluetoothConnectionUpdatesParameter.iAP2BluetoothTransportComponentIdentifier[i], &i, sizeof(U16));
            theiAP2StartBluetoothConnectionUpdatesParameter.iAP2BluetoothTransportComponentIdentifier_count++;
        }
    }

    rc = iap2SendMqRecvAck(mq_fd, g_iap2TestDevice.mqAppTskFd,
                               MQ_CMD_START_BT_UPDATE,
                               &theiAP2StartBluetoothConnectionUpdatesParameter, sizeof(iAP2StartBluetoothConnectionUpdatesParameter));

    iAP2FreeiAP2StartBluetoothConnectionUpdatesParameter(&theiAP2StartBluetoothConnectionUpdatesParameter);
...
LOCAL S32 iap2TestStopBluetoothConnectionUpdates(S32 mq_fd, iAP2Device_t* iap2Device)
{
    S32 rc = IAP2_CTL_ERROR;
    iAP2StopBluetoothConnectionUpdatesParameter theiAP2StopBluetoothConnectionUpdatesParameter;

    /* temporary fix for compiler warnings */
    iap2Device = iap2Device;

    memset(&theiAP2StopBluetoothConnectionUpdatesParameter, 0, sizeof(iAP2StopBluetoothConnectionUpdatesParameter));

    rc = iap2SendMqRecvAck(mq_fd, g_iap2TestDevice.mqAppTskFd,
                               MQ_CMD_STOP_BT_UPDATE,
                               &theiAP2StopBluetoothConnectionUpdatesParameter, sizeof(iAP2StopBluetoothConnectionUpdatesParameter));

    return rc;

}

S32 iap2BluetoothConnectionUpdate_CB(iAP2Device_t* iap2Device, iAP2BluetoothConnectionUpdateParameter *theiAP2BluetoothConnectionUpdateParameter, void* context)
{
    S32 rc = IAP2_CTL_ERROR;
    ...
    if(theiAP2BluetoothConnectionUpdateParameter != NULL)
    {
        printf("\n\n###################### Bluetooth Connection updates ######################\n");

        iap2SetTestState(BT_CONNECTION_UPDATE_RECV, TRUE);
        if(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothTransportComponentIdentifier != NULL)
        {
            printf("\n** Bluetooth Transport component Identifier: %d", *(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothTransportComponentIdentifier));
        }
        if(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothComponentProfiles != NULL)
        {
            if(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothComponentProfiles->iAP2BluetoothHandsFreeProfile != NULL)
            {
                printf("\n** Enabled iAP2BluetoothHandsfree");
            }
            if(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothComponentProfiles->iAP2BluetoothPhoneBookAccessProfile != NULL)
            {
                printf("\n** Enabled iAP2BluetoothPhonebook access");
            }
            if(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothComponentProfiles->iAP2BluetoothAudioVideoRemotecontrolProfile != NULL)
            {
                printf("\n** Enabled iAP2BluetoothAudioVideoRemoteControl");
            }
            if(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothComponentProfiles->iAP2BluetoothAdvancedAudioDistributionProfile != NULL)
            {
                printf("\n** Enabled iAP2BluetoothAdvancedAudioDistributionProfile");
            }
            if(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothComponentProfiles->iAP2BluetoothHumanInterfaceDeviceProfile != NULL)
            {
                printf("\n** Enabled iAP2BluetoothHumanInterfaceDeviceProfile");
            }
            if(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothComponentProfiles->iAP2BluetoothiAP2LinkProfile != NULL)
            {
                printf("\n** Enabled iAP2BluetoothiAP2Link");
            }
            if(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothComponentProfiles->iAP2BluetoothPersonalAreaNetworkAccessPointProfile != NULL)
            {
                printf("\n** Enabled iAP2BluetoothPersonalAreaNetworkAccessPoint");
            }
            if(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothComponentProfiles->iAP2BluetoothMessageAccessProfile != NULL)
            {
                printf("\n** Enabled iAP2BluetoothMessageAccess");
            }
            if(theiAP2BluetoothConnectionUpdateParameter->iAP2BluetoothComponentProfiles->iAP2BluetoothPersonalAreaNetworkClientProfile != NULL)
            {
                printf("\n** Enabled iAP2BluetoothPersonalAreaNetworkClient");
            }
            printf("\n\n######################################################################\n");
        }
    }
    ...
    if(rc > 0)
    {
        ...
        if(mq_st == NULL){
            ...
            switch(mq_st->mq_cmd)
            {
                ...
                case MQ_CMD_BT_COMP_INFO:
                {
                    /* Sending iAP2BluetoothComponentInformation to device */
                    rc = iAP2BluetoothComponentInformation(iap2Device, (iAP2BluetoothComponentInformationParameter*)mq_st->param);
                    if(rc != IAP2_OK)
                    {
                        printf(" %d ms:  iAP2BluetoothComponentInformation failed!  rc = %d \n", iap2CurrTimeMs(), rc);
                        iap2SetTestStateError(TRUE);
                    }
                    break;
                }

                case MQ_CMD_START_BT_UPDATE:
                {
                    rc = iAP2StartBluetoothConnectionUpdates(iap2Device, (iAP2StartBluetoothConnectionUpdatesParameter*)(mq_st->param));
                    if(rc != IAP2_OK)
                    {
                        printf(" %d ms:  iAP2StartBluetoothConnectionUpdates failed!  rc = %d \n", iap2CurrTimeMs(), rc);
                        iap2SetTestStateError(TRUE);
                    }
                    break;
                }

                case MQ_CMD_STOP_BT_UPDATE:
                {
                    rc = iAP2StopBluetoothConnectionUpdates(iap2Device, (iAP2StopBluetoothConnectionUpdatesParameter*)(mq_st->param));
                    if(rc != IAP2_OK)
                    {
                        printf(" %d ms:  iAP2StopBluetoothConnectionUpdates failed!  rc = %d \n", iap2CurrTimeMs(), rc);
                        iap2SetTestStateError(TRUE);
                    }
                    break;
                }
...
void iap2InitCSCallbacks(iAP2SessionCallbacks_t* iap2CSCallbacks)
{
    ...
    iap2CSCallbacks->iAP2BluetoothConnectionUpdate_cb               = &iap2BluetoothConnectionUpdate_CB;
...
LOCAL S32 iap2StartTest(S32 mq_fd, iAP2Device_t* iap2device)
{
    ...
    if((g_iap2TestDevice.testDeviceState != iAP2ComError)
        && (iap2GetTestStateError() != TRUE))
    {
        printf("\n %d ms  iap2TestBluetoothComponentInfo() \n", iap2CurrTimeMs());
        rc = iap2TestBluetoothComponentInfo(mq_fd, iap2device);
        iap2SleepMs(500);
    }

    if((rc == IAP2_OK) && (iap2GetTestStateError() != TRUE))
    {
        printf("\n %d ms  iap2TestStartBluetoothConnectionUpdates() \n", iap2CurrTimeMs());
        rc = iap2TestStartBluetoothConnectionUpdates(mq_fd, iap2device);
        printf("\nTo get connection updtes, disconnect the paired device and connect again(within 15sec)");
        retry_count = 0;
    ...
    if((rc == IAP2_OK) && (iap2GetTestStateError() != TRUE))
    {
        printf("\n %d ms  iap2TestStopBluetoothConnectionUpdates() \n", iap2CurrTimeMs());
        rc = iap2TestStopBluetoothConnectionUpdates(mq_fd, iap2device);
        iap2SleepMs(500);
    }
    else
    {
        if(iap2GetTestState(BT_CONNECTION_UPDATE_RECV) != TRUE)
        {
            g_rc = IAP2_CTL_ERROR;
        }
        printf("\n Exited with retry count: %d", retry_count);
    }
    return rc;
}
...
LOCAL S32 application_process_main (int socket_fd)
{
    ...
    if(g_rc == IAP2_OK)
    {
        printf("iap2_bluetooth_connection_test                 PASS       %d\n", g_rc);
        IAP2TESTDLTLOG(DLT_LOG_INFO, "***** iAP2 BTCONNECTION TEST PASS *****");
    }
    else
    {
        printf("iap2_bluetooth_connection_test                 FAIL       %d\n", g_rc);
        IAP2TESTDLTLOG(DLT_LOG_ERROR, "***** iAP2 BT CONNECTION TEST FAIL *****");
    }
