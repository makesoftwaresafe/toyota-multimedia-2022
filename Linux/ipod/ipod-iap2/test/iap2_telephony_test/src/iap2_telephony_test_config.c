...
U16 USBDeviceModeMsgSentByAcc[] = {                         \
    ...
    IAP2_MSG_ID_START_TELEPHONY_CALL_STATE_INFORMATION,     \
    IAP2_MSG_ID_START_TELEPHONY_UPDATES,                    \
    IAP2_MSG_ID_STOP_TELEPHONY_CALL_STATE_INFORMATION,      \
    IAP2_MSG_ID_STOP_TELEPHONY_UPDATES                      \
    };

U16 USBDeviceModeMsgRecvFromDevice[] = {                    \
    IAP2_MSG_ID_POWER_UPDATE,                               \
    IAP2_MSG_ID_TELEPHONY_CALL_STATE_INFORMATION,           \
    IAP2_MSG_ID_TELEPHONY_UPDATE                            \
};
