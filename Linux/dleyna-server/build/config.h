...
#define DLEYNA_SERVER_INTERFACE_MANAGER "com.intel.dLeynaServer.Manager"

/* d-Bus Name of dleyna-server device interface */
#define DLEYNA_SERVER_INTERFACE_MEDIA_DEVICE "com.intel.dLeynaServer.MediaDevice"

/* d-Bus Name of dleyna-server */
#define DLEYNA_SERVER_NAME "com.intel.dleyna-server"

/* Name of object exposed by dleyna-server */
#define DLEYNA_SERVER_OBJECT "/com/intel/dLeynaServer"

/* Path of server objects */
#define DLEYNA_SERVER_PATH "/com/intel/dLeynaServer/server"
...
/* Name of package */
#define PACKAGE "dleyna-server"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "https://github.com/01org/dleyna-server/issues/new"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dleyna-server"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dleyna-server 0.6.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dleyna-server"
