...
static guint                       NSMA__u32RequestCount       = 0;
static guint                       NSMA__u32CurrentRequestId   = 0;
                                                         ...
                                                         gpointer               pUserData)
{
  ...
  if(NSMA__u32CurrentRequestId == u32RequestId)
  {
                                    ...
                                    guint                  u32ShutdownType)
{
  ...
  /* Increment Request count and send it as Request Id. Ideally request count doesn't overflow. */
  NSMA__u32CurrentRequestId = ++NSMA__u32RequestCount;

  node_state_life_cycle_consumer_call_lifecycle_request((NodeStateLifeCycleConsumer*) hLcClient,
                                                        u32ShutdownType,
                                                        NSMA__u32CurrentRequestId,
                                                        NULL,
