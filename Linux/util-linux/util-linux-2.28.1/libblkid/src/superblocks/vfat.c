			...
			uint32_t *cluster_count, uint32_t *fat_size)
{
	...
	if (mag->len <= 2) {
		...
		/**
		/* ADIT patch to solve SWGIII-8075. Block devices with vfat 
		/* superblocks with missing file system tag and missing
		/* 0x55AA signature are still detected with this change
		*/
