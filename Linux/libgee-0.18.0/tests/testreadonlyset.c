/* testreadonlyset.c generated by valac 0.26.0, the Vala compiler
...
static void read_only_set_tests_class_init (ReadOnlySetTestsClass * klass) {
	...
	((GeeTestCaseClass *) klass)->set_up = read_only_set_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = read_only_set_tests_real_tear_down;
	((ReadOnlyCollectionTestsClass *) klass)->get_ro_view = read_only_set_tests_real_get_ro_view;
}
