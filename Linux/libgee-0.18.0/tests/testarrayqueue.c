/* testarrayqueue.c generated by valac 0.26.0, the Vala compiler
...
static void array_queue_tests_class_init (ArrayQueueTestsClass * klass) {
	...
	((GeeTestCaseClass *) klass)->set_up = array_queue_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = array_queue_tests_real_tear_down;
}
