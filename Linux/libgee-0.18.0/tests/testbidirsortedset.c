/* testbidirsortedset.c generated by valac 0.26.0, the Vala compiler
...
static void bidir_sorted_set_tests_bidir_sub_set_tests_class_init (BidirSortedSetTestsBidirSubSetTestsClass * klass) {
	...
	((GeeTestCaseClass *) klass)->set_up = bidir_sorted_set_tests_bidir_sub_set_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = bidir_sorted_set_tests_bidir_sub_set_tests_real_tear_down;
