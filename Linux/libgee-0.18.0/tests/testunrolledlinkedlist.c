/* testunrolledlinkedlist.c generated by valac 0.26.0, the Vala compiler
...
enum  {
	UNROLLED_LINKED_LIST_TESTS_DUMMY_PROPERTY
};
...
static void unrolled_linked_list_tests_class_init (UnrolledLinkedListTestsClass * klass) {
	unrolled_linked_list_tests_parent_class = g_type_class_peek_parent (klass);
	((GeeTestCaseClass *) klass)->set_up = unrolled_linked_list_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = unrolled_linked_list_tests_real_tear_down;
}


static void unrolled_linked_list_tests_instance_init (UnrolledLinkedListTests * self) {
}


GType unrolled_linked_list_tests_get_type (void) {
