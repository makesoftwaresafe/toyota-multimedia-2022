/* testcase.c generated by valac 0.26.0, the Vala compiler
...
void gee_test_case_add_test (GeeTestCase* self, const gchar* name, GeeTestCaseTestMethod test, void* test_target, GDestroyNotify test_target_destroy_notify) {
	...
	const gchar* _tmp0_ = NULL;
	GeeTestCaseTestMethod _tmp1_ = NULL;
	void* _tmp1__target = NULL;
	GDestroyNotify _tmp1__target_destroy_notify = NULL;
	GeeTestCaseAdaptor* _tmp2_ = NULL;
	GeeTestCaseAdaptor** _tmp3_ = NULL;
	gint _tmp3__length1 = 0;
	GeeTestCaseAdaptor* _tmp4_ = NULL;
...
static GeeTestCaseAdaptor* gee_test_case_adaptor_construct (GType object_type, const gchar* name, GeeTestCaseTestMethod test, void* test_target, GDestroyNotify test_target_destroy_notify, GeeTestCase* test_case) {
	...
	void* _tmp1__target = NULL;
	GDestroyNotify _tmp1__target_destroy_notify = NULL;
	GeeTestCase* _tmp2_ = NULL;
	GeeTestCase* _tmp3_ = NULL;
	g_return_val_if_fail (name != NULL, NULL);
...
static void gee_test_case_adaptor_run (GeeTestCaseAdaptor* self, void* fixture) {
	GeeTestCaseTestMethod _tmp0_ = NULL;
...
static void gee_test_case_class_init (GeeTestCaseClass * klass) {
	...
	((GeeTestCaseClass *) klass)->set_up = gee_test_case_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = gee_test_case_real_tear_down;
