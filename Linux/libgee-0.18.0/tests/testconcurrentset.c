/* testconcurrentset.c generated by valac 0.26.0, the Vala compiler
...
static void concurrent_set_tests_class_init (ConcurrentSetTestsClass * klass) {
	...
	((GeeTestCaseClass *) klass)->set_up = concurrent_set_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = concurrent_set_tests_real_tear_down;
}
