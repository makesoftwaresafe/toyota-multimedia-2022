/* testconcurrentlist.c generated by valac 0.26.0, the Vala compiler
...
static void concurrent_list_tests_class_init (ConcurrentListTestsClass * klass) {
	...
	((GeeTestCaseClass *) klass)->set_up = concurrent_list_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = concurrent_list_tests_real_tear_down;
}
