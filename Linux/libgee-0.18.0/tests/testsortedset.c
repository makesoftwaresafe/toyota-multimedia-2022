/* testsortedset.c generated by valac 0.26.0, the Vala compiler
...
SortedSetTests* sorted_set_tests_construct (GType object_type, const gchar* name, gboolean strict) {
	...
	SortedSetTestsSubSetTests* _tmp4_ = NULL;
	SortedSetTestsSubSetTests* _tmp5_ = NULL;
	GTestSuite* _tmp6_ = NULL;
	GTestSuite* _tmp7_ = NULL;
	gboolean _tmp8_ = FALSE;
	SortedSetTestsSubSetTests* _tmp9_ = NULL;
	SortedSetTestsSubSetTests* _tmp10_ = NULL;
	GTestSuite* _tmp11_ = NULL;
	GTestSuite* _tmp12_ = NULL;
	gboolean _tmp13_ = FALSE;
	SortedSetTestsSubSetTests* _tmp14_ = NULL;
	SortedSetTestsSubSetTests* _tmp15_ = NULL;
	GTestSuite* _tmp16_ = NULL;
	GTestSuite* _tmp17_ = NULL;
	gboolean _tmp18_ = FALSE;
	SortedSetTestsSubSetTests* _tmp19_ = NULL;
	SortedSetTestsSubSetTests* _tmp20_ = NULL;
...
SortedSetTestsSubSetTests* sorted_set_tests_sub_set_tests_construct (GType object_type, SortedSetTests* test, SortedSetTestsSubSetTestsType type, gboolean strict) {
	...
	gchar* _tmp2_ = NULL;
	gchar* _tmp3_ = NULL;
	SortedSetTests* _tmp4_ = NULL;
	SortedSetTests* _tmp5_ = NULL;
...
static void sorted_set_tests_sub_set_tests_real_set_up (GeeTestCase* base) {
	...
	SortedSetTests* _tmp0_ = NULL;
	SortedSetTests* _tmp1_ = NULL;
...
void sorted_set_tests_sub_set_tests_test_size (SortedSetTestsSubSetTests* self) {
	...
	gint _tmp19_ = 0;
	gint _tmp20_ = 0;
	SortedSetTestsSubSetTestsType _tmp21_ = 0;
	g_return_if_fail (self != NULL);
...
void sorted_set_tests_sub_set_tests_test_remove (SortedSetTestsSubSetTests* self) {
	...
	_tmp56__length1 = not_contains_length1;
	{
		...
		for (s_it = 0; s_it < _tmp56__length1; s_it = s_it + 1) {
			...
			s = _tmp57_;
			{
				GeeSortedSet* _tmp58_ = NULL;
				const gchar* _tmp59_ = NULL;
				gboolean _tmp60_ = FALSE;
				GeeSortedSet* _tmp61_ = NULL;
...
void sorted_set_tests_sub_set_tests_test_subsets (SortedSetTestsSubSetTests* self) {
	...
	switch (_tmp15_) {
		...
		case SORTED_SET_TESTS_SUB_SET_TESTS_TYPE_EMPTY:
		{
			...
			GeeSortedSet* _tmp73_ = NULL;
			gint _tmp74_ = 0;
			gint _tmp75_ = 0;
			GeeSortedSet* _tmp76_ = NULL;
...
static void sorted_set_tests_sub_set_tests_class_init (SortedSetTestsSubSetTestsClass * klass) {
	...
	((GeeTestCaseClass *) klass)->set_up = sorted_set_tests_sub_set_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = sorted_set_tests_sub_set_tests_real_tear_down;
