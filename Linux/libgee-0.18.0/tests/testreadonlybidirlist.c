/* testreadonlybidirlist.c generated by valac 0.26.0, the Vala compiler
...
static void read_only_bidir_list_tests_class_init (ReadOnlyBidirListTestsClass * klass) {
	...
	((ReadOnlyCollectionTestsClass *) klass)->get_ro_view = read_only_bidir_list_tests_real_get_ro_view;
}
