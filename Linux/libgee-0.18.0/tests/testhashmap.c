/* testhashmap.c generated by valac 0.26.0, the Vala compiler
...
static void hash_map_tests_class_init (HashMapTestsClass * klass) {
	...
	((GeeTestCaseClass *) klass)->set_up = hash_map_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = hash_map_tests_real_tear_down;
}
