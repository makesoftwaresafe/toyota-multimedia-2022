/* testtreemap.c generated by valac 0.26.0, the Vala compiler
...
static void tree_map_tests_class_init (TreeMapTestsClass * klass) {
	...
	((GeeTestCaseClass *) klass)->set_up = tree_map_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = tree_map_tests_real_tear_down;
}
