/* testmap.c generated by valac 0.26.0, the Vala compiler
...
static gint __lambda37_ (MapTests* self, const gchar* x, const gchar* y, gint z);
static gpointer ___lambda37__gee_fold_map_func (gconstpointer k, gconstpointer v, gpointer a, gpointer self);
static gint __lambda38_ (MapTests* self, const gchar* x, const gchar* y, gint z);
static gpointer ___lambda38__gee_fold_map_func (gconstpointer k, gconstpointer v, gpointer a, gpointer self);
static Block12Data* block12_data_ref (Block12Data* _data12_);
static void block12_data_unref (void * _userdata_);
static gboolean __lambda39_ (Block12Data* _data12_, const gchar* x, const gchar* y);
static gboolean ___lambda39__gee_forall_map_func (gconstpointer k, gconstpointer v, gpointer self);
static gboolean __lambda40_ (Block12Data* _data12_, const gchar* x, const gchar* y);
static gboolean ___lambda40__gee_forall_map_func (gconstpointer k, gconstpointer v, gpointer self);
...
void map_tests_test_has_key_size_is_empty (MapTests* self) {
	...
	GeeMap* _tmp101_ = NULL;
	gpointer _tmp102_ = NULL;
	gchar* _tmp103_ = NULL;
	GeeMap* _tmp104_ = NULL;
	gint _tmp105_ = 0;
	gint _tmp106_ = 0;
	GeeMap* _tmp107_ = NULL;
	gboolean _tmp108_ = FALSE;
	gboolean _tmp109_ = FALSE;
	GeeMap* _tmp110_ = NULL;
	GeeMap* _tmp111_ = NULL;
	gboolean _tmp112_ = FALSE;
	GeeMap* _tmp113_ = NULL;
	gpointer _tmp114_ = NULL;
	gchar* _tmp115_ = NULL;
	GeeMap* _tmp116_ = NULL;
	gboolean _tmp117_ = FALSE;
	GeeMap* _tmp118_ = NULL;
	gpointer _tmp119_ = NULL;
	gchar* _tmp120_ = NULL;
	GeeMap* _tmp121_ = NULL;
	gboolean _tmp122_ = FALSE;
	GeeMap* _tmp123_ = NULL;
	gpointer _tmp124_ = NULL;
	gchar* _tmp125_ = NULL;
	GeeMap* _tmp126_ = NULL;
	gint _tmp127_ = 0;
	gint _tmp128_ = 0;
	GeeMap* _tmp129_ = NULL;
	gboolean _tmp130_ = FALSE;
	gboolean _tmp131_ = FALSE;
	GeeMap* _tmp132_ = NULL;
	GeeMap* _tmp133_ = NULL;
	gboolean _tmp134_ = FALSE;
	GeeMap* _tmp135_ = NULL;
	...
	gchar* _tmp142_ = NULL;
	GeeMap* _tmp143_ = NULL;
	gboolean _tmp144_ = FALSE;
	GeeMap* _tmp145_ = NULL;
	gpointer _tmp146_ = NULL;
	gchar* _tmp147_ = NULL;
	GeeMap* _tmp148_ = NULL;
	gint _tmp149_ = 0;
	gint _tmp150_ = 0;
	GeeMap* _tmp151_ = NULL;
...
void map_tests_test_entries (MapTests* self) {
	...
	gint _tmp9_ = 0;
	GeeSet* _tmp10_ = NULL;
	MapTestsTestEntry* _tmp11_ = NULL;
	...
	gint _tmp19_ = 0;
	GeeSet* _tmp20_ = NULL;
	MapTestsTestEntry* _tmp21_ = NULL;
	MapTestsTestEntry* _tmp22_ = NULL;
	...
	gint _tmp32_ = 0;
	GeeSet* _tmp33_ = NULL;
	MapTestsTestEntry* _tmp34_ = NULL;
	MapTestsTestEntry* _tmp35_ = NULL;
	gboolean _tmp36_ = FALSE;
	GeeSet* _tmp37_ = NULL;
	MapTestsTestEntry* _tmp38_ = NULL;
	MapTestsTestEntry* _tmp39_ = NULL;
	gboolean _tmp40_ = FALSE;
	GeeMap* _tmp41_ = NULL;
	GeeSet* _tmp42_ = NULL;
	GeeSet* _tmp43_ = NULL;
	...
	gint _tmp46_ = 0;
	GeeSet* _tmp47_ = NULL;
	MapTestsTestEntry* _tmp48_ = NULL;
	MapTestsTestEntry* _tmp49_ = NULL;
	gboolean _tmp50_ = FALSE;
	GeeSet* _tmp51_ = NULL;
	MapTestsTestEntry* _tmp52_ = NULL;
	MapTestsTestEntry* _tmp53_ = NULL;
	...
	if (_tmp24_) {
		GeeSet* _tmp25_ = NULL;
		MapTestsTestEntry* _tmp26_ = NULL;
...
static gpointer ___lambda37__gee_fold_map_func (gconstpointer k, gconstpointer v, gpointer a, gpointer self) {
	gpointer result;
	result = (gpointer) ((gintptr) __lambda37_ ((MapTests*) self, (const gchar*) k, (const gchar*) v, (gint) ((gintptr) a)));
	return result;
}
...
static gpointer ___lambda38__gee_fold_map_func (gconstpointer k, gconstpointer v, gpointer a, gpointer self) {
	gpointer result;
	result = (gpointer) ((gintptr) __lambda38_ ((MapTests*) self, (const gchar*) k, (const gchar*) v, (gint) ((gintptr) a)));
	return result;
}
...
void map_tests_test_fold (MapTests* self) {
	...
	_tmp5_ = _tmp4_;
	_tmp6_ = gee_map_iterator_fold (_tmp5_, G_TYPE_INT, NULL, NULL, ___lambda37__gee_fold_map_func, self, (gpointer) ((gintptr) 0));
	...
	_tmp11_ = gee_map_iterator_fold (iter, G_TYPE_INT, NULL, NULL, ___lambda38__gee_fold_map_func, self, (gpointer) ((gintptr) 0));
...
static gboolean ___lambda39__gee_forall_map_func (gconstpointer k, gconstpointer v, gpointer self) {
	gboolean result;
	result = __lambda39_ (self, (const gchar*) k, (const gchar*) v);
	return result;
}
...
static gboolean ___lambda40__gee_forall_map_func (gconstpointer k, gconstpointer v, gpointer self) {
	gboolean result;
	result = __lambda40_ (self, (const gchar*) k, (const gchar*) v);
	return result;
}
...
void map_tests_test_foreach (MapTests* self) {
	...
	_tmp4_ = gee_map_map_iterator (_tmp3_);
	_tmp5_ = _tmp4_;
	gee_map_iterator_foreach (_tmp5_, ___lambda39__gee_forall_map_func, _data12_);
	_g_object_unref0 (_tmp5_);
	...
	gee_map_iterator_foreach (iter, ___lambda40__gee_forall_map_func, _data12_);
