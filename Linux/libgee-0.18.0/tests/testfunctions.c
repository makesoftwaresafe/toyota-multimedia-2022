/* testfunctions.c generated by valac 0.26.0, the Vala compiler
...
static GeeLazy* __lambda41_ (Block8Data* _data8_);
static Block9Data* block9_data_ref (Block9Data* _data9_);
static void block9_data_unref (void * _userdata_);
static gint __lambda42_ (Block9Data* _data9_);
static gpointer ___lambda42__gee_lazy_func (gpointer self);
static GeeLazy* ___lambda41__gee_unfold_func (gpointer self);
static Block10Data* block10_data_ref (Block10Data* _data10_);
static void block10_data_unref (void * _userdata_);
static GeeLazy* __lambda43_ (Block10Data* _data10_);
static Block11Data* block11_data_ref (Block11Data* _data11_);
static void block11_data_unref (void * _userdata_);
static GeeLazy* __lambda44_ (Block11Data* _data11_);
static GeeLazy* ___lambda44__gee_unfold_func (gpointer self);
static GeeLazy* ___lambda43__gee_unfold_func (gpointer self);
...
static gpointer ___lambda42__gee_lazy_func (gpointer self) {
	gpointer result;
	result = (gpointer) ((gintptr) __lambda42_ (self));
	return result;
}
...
static GeeLazy* __lambda41_ (Block8Data* _data8_) {
	...
	_data8_->i = _tmp3_ + 1;
	_data9_->k = _tmp3_;
	_tmp4_ = gee_lazy_new (G_TYPE_INT, NULL, NULL, ___lambda42__gee_lazy_func, block9_data_ref (_data9_), block9_data_unref);
	result = _tmp4_;
	block9_data_unref (_data9_);
	_data9_ = NULL;
	return result;
...
void functions_tests_test_unfold (FunctionsTests* self) {
	...
	_data8_->i = 0;
	_data8_->j = -1;
	_tmp0_ = gee_iterator_unfold (G_TYPE_INT, NULL, NULL, ___lambda41__gee_unfold_func, block8_data_ref (_data8_), block8_data_unref, NULL);
	iter = _tmp0_;
	k = 0;
	while (TRUE) {
...
static GeeLazy* __lambda43_ (Block10Data* _data10_) {
	...
	_tmp3_ = gee_iterator_unfold (G_TYPE_INT, NULL, NULL, ___lambda44__gee_unfold_func, block11_data_ref (_data11_), block11_data_unref, NULL);
	iter = _tmp3_;
	_tmp4_ = iter;
...
void functions_tests_test_concat (FunctionsTests* self) {
	...
	_data10_->i = 0;
	_tmp0_ = gee_iterator_unfold (GEE_TYPE_ITERATOR, (GBoxedCopyFunc) g_object_ref, g_object_unref, ___lambda43__gee_unfold_func, block10_data_ref (_data10_), block10_data_unref, NULL);
	iter_ = _tmp0_;
	j = 0;
	_tmp1_ = iter_;
