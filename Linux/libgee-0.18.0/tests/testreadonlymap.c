/* testreadonlymap.c generated by valac 0.26.0, the Vala compiler
...
static void read_only_map_tests_class_init (ReadOnlyMapTestsClass * klass) {
	...
	((GeeTestCaseClass *) klass)->set_up = read_only_map_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = read_only_map_tests_real_tear_down;
