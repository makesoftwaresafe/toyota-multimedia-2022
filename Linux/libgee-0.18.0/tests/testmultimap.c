/* testmultimap.c generated by valac 0.26.0, the Vala compiler
...
static void multi_map_tests_test_getting_setting (MultiMapTests* self) {
	...
	GeeMultiMap* _tmp105_ = NULL;
	gboolean _tmp106_ = FALSE;
	GeeMultiMap* _tmp107_ = NULL;
	GeeCollection* _tmp108_ = NULL;
	GeeCollection* _tmp109_ = NULL;
	gboolean _tmp110_ = FALSE;
	GeeMultiMap* _tmp111_ = NULL;
	GeeMultiMap* _tmp112_ = NULL;
	gboolean _tmp113_ = FALSE;
	GeeMultiMap* _tmp114_ = NULL;
	gboolean _tmp115_ = FALSE;
	GeeMultiMap* _tmp116_ = NULL;
	GeeMultiMap* _tmp117_ = NULL;
	GeeMultiMap* _tmp118_ = NULL;
	GeeMultiMap* _tmp119_ = NULL;
	gint _tmp120_ = 0;
	gint _tmp121_ = 0;
	GeeMultiMap* _tmp122_ = NULL;
	...
	gint _tmp129_ = 0;
	gint _tmp130_ = 0;
	GeeMultiMap* _tmp131_ = NULL;
	GeeCollection* _tmp132_ = NULL;
	GeeCollection* _tmp133_ = NULL;
	...
	GeeCollection* _tmp141_ = NULL;
	gint _tmp142_ = 0;
	gint _tmp143_ = 0;
	GeeMultiMap* _tmp144_ = NULL;
	GeeCollection* _tmp145_ = NULL;
	GeeCollection* _tmp146_ = NULL;
	gboolean _tmp147_ = FALSE;
	GeeMultiMap* _tmp148_ = NULL;
	gboolean _tmp149_ = FALSE;
	GeeMultiMap* _tmp150_ = NULL;
	gboolean _tmp151_ = FALSE;
	GeeMultiMap* _tmp152_ = NULL;
	...
	GeeCollection* _tmp164_ = NULL;
	gboolean _tmp165_ = FALSE;
	GeeMultiMap* _tmp166_ = NULL;
	gboolean _tmp167_ = FALSE;
	GeeMultiMap* _tmp168_ = NULL;
	gboolean _tmp169_ = FALSE;
	GeeMultiMap* _tmp170_ = NULL;
	GeeCollection* _tmp171_ = NULL;
	GeeCollection* _tmp172_ = NULL;
	gboolean _tmp173_ = FALSE;
	GeeMultiMap* _tmp174_ = NULL;
	GeeCollection* _tmp175_ = NULL;
	GeeCollection* _tmp176_ = NULL;
	gboolean _tmp177_ = FALSE;
	GeeMultiMap* _tmp178_ = NULL;
	gboolean _tmp179_ = FALSE;
	GeeMultiMap* _tmp180_ = NULL;
...
static void multi_map_tests_test_keys_all_keys_values (MultiMapTests* self) {
	...
	GeeMultiSet* _tmp14_ = NULL;
	gint _tmp15_ = 0;
	GeeMultiSet* _tmp16_ = NULL;
	gint _tmp17_ = 0;
