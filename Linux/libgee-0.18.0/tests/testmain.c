/* testmain.c generated by valac 0.26.0, the Vala compiler
...
G_GNUC_INTERNAL void _vala_main (gchar** args, int args_length1);
...
G_GNUC_INTERNAL void _vala_main (gchar** args, int args_length1) {
	...
	GTestSuite* _tmp84_ = NULL;
	UnrolledLinkedListTests* _tmp85_ = NULL;
	UnrolledLinkedListTests* _tmp86_ = NULL;
	GTestSuite* _tmp87_ = NULL;
	GTestSuite* _tmp88_ = NULL;
	UnrolledLinkedListAsDequeTests* _tmp89_ = NULL;
	UnrolledLinkedListAsDequeTests* _tmp90_ = NULL;
	GTestSuite* _tmp91_ = NULL;
