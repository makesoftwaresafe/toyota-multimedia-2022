/* testlinkedlist.c generated by valac 0.26.0, the Vala compiler
...
static void linked_list_tests_class_init (LinkedListTestsClass * klass) {
	...
	((GeeTestCaseClass *) klass)->set_up = linked_list_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = linked_list_tests_real_tear_down;
}
