/* readonlycollection.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
static GeeIterator** gee_read_only_collection_iterator_real_tee (GeeTraversable* base, guint forks, int* result_length1) {
	...
	if (_tmp0_ == ((guint) 0)) {
		...
		if (_tmp10_ == _tmp11_) {
			...
			GeeReadOnlyCollectionIterator* _tmp18_ = NULL;
			...
			_tmp17_ = _tmp16_[0];
			_tmp18_ = gee_read_only_collection_iterator_new (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, self->priv->g_destroy_func, _tmp17_);
		...
		}
		{
			...
			i = (guint) 1;
			{
				...
				while (TRUE) {
					...
					GeeReadOnlyCollectionIterator* _tmp29_ = NULL;
					...
					_tmp29_ = gee_read_only_collection_iterator_new (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, self->priv->g_destroy_func, _tmp28_);
