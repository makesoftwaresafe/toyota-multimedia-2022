/* abstractqueue.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
static void gee_abstract_queue_class_init (GeeAbstractQueueClass * klass) {
	...
	((GeeAbstractQueueClass *) klass)->peek = gee_abstract_queue_real_peek;
	((GeeAbstractQueueClass *) klass)->poll = gee_abstract_queue_real_poll;
	((GeeAbstractQueueClass *) klass)->reserved0 = gee_abstract_queue_real_reserved0;
	((GeeAbstractQueueClass *) klass)->reserved1 = gee_abstract_queue_real_reserved1;
	((GeeAbstractQueueClass *) klass)->reserved2 = gee_abstract_queue_real_reserved2;
	((GeeAbstractQueueClass *) klass)->reserved3 = gee_abstract_queue_real_reserved3;
	((GeeAbstractQueueClass *) klass)->reserved4 = gee_abstract_queue_real_reserved4;
	((GeeAbstractQueueClass *) klass)->reserved5 = gee_abstract_queue_real_reserved5;
	((GeeAbstractQueueClass *) klass)->reserved6 = gee_abstract_queue_real_reserved6;
	((GeeAbstractQueueClass *) klass)->reserved7 = gee_abstract_queue_real_reserved7;
	((GeeAbstractQueueClass *) klass)->reserved8 = gee_abstract_queue_real_reserved8;
	((GeeAbstractQueueClass *) klass)->reserved9 = gee_abstract_queue_real_reserved9;
