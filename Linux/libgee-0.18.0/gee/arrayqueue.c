/* arrayqueue.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
static GeeArrayQueueIterator* gee_array_queue_iterator_construct_from_iterator (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeArrayQueueIterator* iter) {
	...
	GeeArrayQueue* _tmp1_ = NULL;
	GeeArrayQueue* _tmp2_ = NULL;
	GeeArrayQueueIterator* _tmp3_ = NULL;
	gint _tmp4_ = 0;
	GeeArrayQueueIterator* _tmp5_ = NULL;
	gint _tmp6_ = 0;
	GeeArrayQueueIterator* _tmp7_ = NULL;
	...
	}
	{
		...
		i = _tmp6_;
		{
			...
			while (TRUE) {
				...
				GeeArrayQueue* _tmp13_ = NULL;
				gpointer* _tmp14_ = NULL;
				gint _tmp14__length1 = 0;
				GeeArrayQueue* _tmp15_ = NULL;
				gint _tmp16_ = 0;
				gint _tmp17_ = 0;
		...
		_tmp7_ = _tmp5_[0];
		{
			...
			i = (guint) 1;
			{
				...
				while (TRUE) {
					...
					guint _tmp13_ = 0U;
					GeeArrayQueueIterator* _tmp14_ = NULL;
					...
					_tmp13_ = i;
					_tmp14_ = gee_array_queue_iterator_new_from_iterator (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, self->priv->g_destroy_func, self);
...
static void gee_array_queue_class_init (GeeArrayQueueClass * klass) {
	...
	((GeeAbstractCollectionClass *) klass)->iterator = gee_array_queue_real_iterator;
	((GeeAbstractCollectionClass *) klass)->add = gee_array_queue_real_add;
	((GeeAbstractCollectionClass *) klass)->contains = gee_array_queue_real_contains;
	((GeeAbstractCollectionClass *) klass)->remove = gee_array_queue_real_remove;
	((GeeAbstractCollectionClass *) klass)->clear = gee_array_queue_real_clear;
	((GeeAbstractCollectionClass *) klass)->foreach = gee_array_queue_real_foreach;
	((GeeAbstractQueueClass *) klass)->peek = gee_array_queue_real_peek;
	((GeeAbstractQueueClass *) klass)->poll = gee_array_queue_real_poll;
