/* abstractlist.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
static GObject * gee_abstract_list_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties);
...
static GeeList* gee_abstract_list_real_get_read_only_view (GeeAbstractList* base) {
	...
	_tmp1_ = instance;
	if (_tmp1_ == NULL) {
		GeeReadOnlyList* _tmp2_ = NULL;
		GeeList* _tmp3_ = NULL;
		_tmp2_ = gee_read_only_list_new (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, self->priv->g_destroy_func, (GeeList*) self);
...
static void gee_abstract_list_class_init (GeeAbstractListClass * klass) {
	...
	((GeeAbstractListClass *) klass)->list_iterator = gee_abstract_list_real_list_iterator;
	((GeeAbstractListClass *) klass)->get = gee_abstract_list_real_get;
	((GeeAbstractListClass *) klass)->set = gee_abstract_list_real_set;
	((GeeAbstractListClass *) klass)->index_of = gee_abstract_list_real_index_of;
	((GeeAbstractListClass *) klass)->insert = gee_abstract_list_real_insert;
	((GeeAbstractListClass *) klass)->remove_at = gee_abstract_list_real_remove_at;
	((GeeAbstractListClass *) klass)->slice = gee_abstract_list_real_slice;
	((GeeAbstractListClass *) klass)->reserved0 = gee_abstract_list_real_reserved0;
	((GeeAbstractListClass *) klass)->reserved1 = gee_abstract_list_real_reserved1;
	((GeeAbstractListClass *) klass)->reserved2 = gee_abstract_list_real_reserved2;
	((GeeAbstractListClass *) klass)->reserved3 = gee_abstract_list_real_reserved3;
	((GeeAbstractListClass *) klass)->reserved4 = gee_abstract_list_real_reserved4;
	((GeeAbstractListClass *) klass)->reserved5 = gee_abstract_list_real_reserved5;
	((GeeAbstractListClass *) klass)->reserved6 = gee_abstract_list_real_reserved6;
	((GeeAbstractListClass *) klass)->reserved7 = gee_abstract_list_real_reserved7;
	((GeeAbstractListClass *) klass)->reserved8 = gee_abstract_list_real_reserved8;
	((GeeAbstractListClass *) klass)->reserved9 = gee_abstract_list_real_reserved9;
