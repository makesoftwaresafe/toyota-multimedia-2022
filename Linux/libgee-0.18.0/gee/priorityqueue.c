/* priorityqueue.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
static gpointer gee_priority_queue_real_poll (GeeAbstractQueue* base) {
	...
	GeePriorityQueueType2Node* _tmp47_ = NULL;
	...
	while (TRUE) {
		...
		if (_tmp37_) {
			GeePriorityQueueType1Node* _tmp42_ = NULL;
...
static void _gee_priority_queue_updated_degree (GeePriorityQueue* self, GeePriorityQueueType1Node* node, gboolean child_removed) {
	...
	GeePriorityQueueType1Node* _tmp33_ = NULL;
	GeePriorityQueueType1Node* _tmp61_ = NULL;
	GeePriorityQueueNodePair* _tmp62_ = NULL;
	g_return_if_fail (self != NULL);
	g_return_if_fail (node != NULL);
	_tmp0_ = node;
	_tmp1_ = gee_priority_queue_node_degree ((GeePriorityQueueNode*) _tmp0_);
	...
	if (_tmp62_ != NULL) {
		...
		GeePriorityQueueType1Node* _tmp65_ = NULL;
		GeePriorityQueueNodePair* _tmp66_ = NULL;
		GeePriorityQueueType1Node* _tmp67_ = NULL;
		GeePriorityQueueType1Node* _tmp68_ = NULL;
		GeePriorityQueueType1Node* other = NULL;
		GeePriorityQueueType1Node* _tmp73_ = NULL;
		GeePriorityQueueType1Node* _tmp74_ = NULL;
		GeePriorityQueueType1Node* _tmp75_ = NULL;
		GeePriorityQueueNodePair* _tmp76_ = NULL;
		GeePriorityQueueNodePair* _tmp77_ = NULL;
		...
		if (_tmp67_ == _tmp68_) {
			...
			GeePriorityQueueNodePair* _tmp71_ = NULL;
			GeePriorityQueueType1Node* _tmp72_ = NULL;
			_tmp71_ = pair;
		...
		if (_tmp77_ != NULL) {
			GeePriorityQueueNodePair* _tmp78_ = NULL;
			GeePriorityQueueNodePair* _tmp79_ = NULL;
...
static GeePriorityQueueIterator* gee_priority_queue_iterator_construct_from_iterator (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeePriorityQueueIterator* iter) {
	...
	GeePriorityQueueIterator* _tmp3_ = NULL;
	GeePriorityQueueNode* _tmp4_ = NULL;
	GeePriorityQueueIterator* _tmp5_ = NULL;
	GeePriorityQueueNode* _tmp6_ = NULL;
	GeePriorityQueueIterator* _tmp7_ = NULL;
	gint _tmp8_ = 0;
		...
		_tmp7_ = _tmp5_[0];
		{
			...
			i = (guint) 1;
			{
				...
				while (TRUE) {
					...
					guint _tmp13_ = 0U;
					GeePriorityQueueIterator* _tmp14_ = NULL;
					...
					_tmp13_ = i;
					_tmp14_ = gee_priority_queue_iterator_new_from_iterator (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, self->priv->g_destroy_func, self);
...
static void gee_priority_queue_class_init (GeePriorityQueueClass * klass) {
	...
	((GeeAbstractQueueClass *) klass)->peek = gee_priority_queue_real_peek;
	((GeeAbstractQueueClass *) klass)->poll = gee_priority_queue_real_poll;
	((GeeAbstractCollectionClass *) klass)->contains = gee_priority_queue_real_contains;
	((GeeAbstractCollectionClass *) klass)->add = gee_priority_queue_real_add;
	((GeeAbstractCollectionClass *) klass)->remove = gee_priority_queue_real_remove;
	((GeeAbstractCollectionClass *) klass)->clear = gee_priority_queue_real_clear;
	((GeeAbstractCollectionClass *) klass)->iterator = gee_priority_queue_real_iterator;
	((GeeAbstractCollectionClass *) klass)->foreach = gee_priority_queue_real_foreach;
