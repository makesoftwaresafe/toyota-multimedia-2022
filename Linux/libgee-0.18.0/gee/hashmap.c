/* hashmap.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
G_GNUC_INTERNAL GeeHashMap* gee_hash_map_new_with_closures (GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeFunctionsHashDataFuncClosure* key_hash_func, GeeFunctionsEqualDataFuncClosure* key_equal_func, GeeFunctionsEqualDataFuncClosure* value_equal_func);
...
static GeeHashMapNodeIterator* gee_hash_map_node_iterator_construct_from_iterator (GType object_type, GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashMapNodeIterator* iter);
...
static GeeHashMapKeyIterator* gee_hash_map_key_iterator_new_from_iterator (GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashMapKeyIterator* iter);
static GeeHashMapKeyIterator* gee_hash_map_key_iterator_construct_from_iterator (GType object_type, GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashMapKeyIterator* iter);
...
static GeeIterator** gee_hash_map_key_iterator_real_tee (GeeTraversable* base, guint forks, int* result_length1);
...
static GeeHashMapValueIterator* gee_hash_map_value_iterator_new_from_iterator (GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashMapValueIterator* iter);
static GeeHashMapValueIterator* gee_hash_map_value_iterator_construct_from_iterator (GType object_type, GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashMapValueIterator* iter);
...
static GeeIterator** gee_hash_map_value_iterator_real_tee (GeeTraversable* base, guint forks, int* result_length1);
...
static GeeHashMapEntryIterator* gee_hash_map_entry_iterator_new_from_iterator (GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashMapEntryIterator* iter);
static GeeHashMapEntryIterator* gee_hash_map_entry_iterator_construct_from_iterator (GType object_type, GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashMapEntryIterator* iter);
...
static GeeIterator** gee_hash_map_entry_iterator_real_tee (GeeTraversable* base, guint forks, int* result_length1);
...
GeeHashMap* gee_hash_map_construct (GType object_type, GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashDataFunc key_hash_func, void* key_hash_func_target, GDestroyNotify key_hash_func_target_destroy_notify, GeeEqualDataFunc key_equal_func, void* key_equal_func_target, GDestroyNotify key_equal_func_target_destroy_notify, GeeEqualDataFunc value_equal_func, void* value_equal_func_target, GDestroyNotify value_equal_func_target_destroy_notify) {
	...
	GeeFunctionsHashDataFuncClosure* _tmp13_ = NULL;
	GeeEqualDataFunc _tmp14_ = NULL;
	void* _tmp14__target = NULL;
	GDestroyNotify _tmp14__target_destroy_notify = NULL;
	GeeFunctionsEqualDataFuncClosure* _tmp15_ = NULL;
	GeeEqualDataFunc _tmp16_ = NULL;
	void* _tmp16__target = NULL;
	GDestroyNotify _tmp16__target_destroy_notify = NULL;
	GeeFunctionsEqualDataFuncClosure* _tmp17_ = NULL;
	gint _tmp18_ = 0;
	...
	_tmp12__target_destroy_notify = key_hash_func_target_destroy_notify;
	key_hash_func_target_destroy_notify = NULL;
	_tmp13_ = gee_functions_hash_data_func_closure_new (k_type, (GBoxedCopyFunc) k_dup_func, k_destroy_func, _tmp12_, _tmp12__target, _tmp12__target_destroy_notify);
	_gee_functions_hash_data_func_closure_unref0 (self->priv->_key_hash_func);
	self->priv->_key_hash_func = _tmp13_;
	_tmp14_ = key_equal_func;
	_tmp14__target = key_equal_func_target;
	_tmp14__target_destroy_notify = key_equal_func_target_destroy_notify;
	key_equal_func_target_destroy_notify = NULL;
	_tmp15_ = gee_functions_equal_data_func_closure_new (k_type, (GBoxedCopyFunc) k_dup_func, k_destroy_func, _tmp14_, _tmp14__target, _tmp14__target_destroy_notify);
	_gee_functions_equal_data_func_closure_unref0 (self->priv->_key_equal_func);
	self->priv->_key_equal_func = _tmp15_;
	_tmp16_ = value_equal_func;
	_tmp16__target = value_equal_func_target;
	_tmp16__target_destroy_notify = value_equal_func_target_destroy_notify;
	value_equal_func_target_destroy_notify = NULL;
	_tmp17_ = gee_functions_equal_data_func_closure_new (v_type, (GBoxedCopyFunc) v_dup_func, v_destroy_func, _tmp16_, _tmp16__target, _tmp16__target_destroy_notify);
	_gee_functions_equal_data_func_closure_unref0 (self->priv->_value_equal_func);
	self->priv->_value_equal_func = _tmp17_;
	self->priv->_array_size = GEE_HASH_MAP_MIN_SIZE;
	_tmp18_ = self->priv->_array_size;
	_tmp19_ = g_new0 (GeeHashMapNode*, _tmp18_ + 1);
	...
	self->priv->_nodes_length1 = _tmp18_;
...
G_GNUC_INTERNAL GeeHashMap* gee_hash_map_construct_with_closures (GType object_type, GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeFunctionsHashDataFuncClosure* key_hash_func, GeeFunctionsEqualDataFuncClosure* key_equal_func, GeeFunctionsEqualDataFuncClosure* value_equal_func) {
	...
	GeeFunctionsEqualDataFuncClosure* _tmp4_ = NULL;
	...
	_gee_functions_hash_data_func_closure_unref0 (self->priv->_key_hash_func);
	self->priv->_key_hash_func = _tmp1_;
	_tmp2_ = key_equal_func;
	_tmp3_ = _gee_functions_equal_data_func_closure_ref0 (_tmp2_);
	_gee_functions_equal_data_func_closure_unref0 (self->priv->_key_equal_func);
	self->priv->_key_equal_func = _tmp3_;
	_tmp4_ = value_equal_func;
	_tmp5_ = _gee_functions_equal_data_func_closure_ref0 (_tmp4_);
	_gee_functions_equal_data_func_closure_unref0 (self->priv->_value_equal_func);
	self->priv->_value_equal_func = _tmp5_;
	self->priv->_array_size = GEE_HASH_MAP_MIN_SIZE;
	_tmp6_ = self->priv->_array_size;
	_tmp7_ = g_new0 (GeeHashMapNode*, _tmp6_ + 1);
	self->priv->_nodes = (_vala_array_free (self->priv->_nodes, self->priv->_nodes_length1, (GDestroyNotify) gee_hash_map_node_free), NULL);
...
static inline void gee_hash_map_resize (GeeHashMap* self) {
	...
	if (_tmp1_) {
		...
		if ((3 * _tmp6_) <= _tmp7_) {
			...
			_tmp5_ = _tmp8_ < GEE_HASH_MAP_MAX_SIZE;
		} else {
			_tmp5_ = FALSE;
		}
		_tmp0_ = _tmp5_;
	...
	if (_tmp0_) {
		...
		_tmp12_ = CLAMP (_tmp11_, GEE_HASH_MAP_MIN_SIZE, GEE_HASH_MAP_MAX_SIZE);
		new_array_size = _tmp12_;
		_tmp13_ = new_array_size;
		_tmp14_ = g_new0 (GeeHashMapNode*, _tmp13_ + 1);
		new_nodes = _tmp14_;
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					next = NULL;
					{
						...
						_tmp22_ = TRUE;
						while (TRUE) {
							GeeHashMapNode* _tmp24_ = NULL;
							GeeHashMapNode* _tmp25_ = NULL;
							GeeHashMapNode* _tmp26_ = NULL;
							guint hash_val = 0U;
							GeeHashMapNode* _tmp27_ = NULL;
							guint _tmp28_ = 0U;
							gint _tmp29_ = 0;
							...
							guint _tmp32_ = 0U;
							GeeHashMapNode* _tmp33_ = NULL;
							GeeHashMapNode** _tmp34_ = NULL;
							gint _tmp34__length1 = 0;
							guint _tmp35_ = 0U;
							GeeHashMapNode* _tmp36_ = NULL;
							GeeHashMapNode* _tmp37_ = NULL;
							if (!_tmp22_) {
							...
							_gee_hash_map_node_free0 (_tmp30_->next);
							...
							_tmp36_ = node;
							node = NULL;
							_gee_hash_map_node_free0 (_tmp34_[_tmp35_]);
...
static void gee_hash_map_key_set_class_init (GeeHashMapKeySetClass * klass) {
	...
	((GeeAbstractCollectionClass *) klass)->iterator = gee_hash_map_key_set_real_iterator;
	((GeeAbstractCollectionClass *) klass)->add = gee_hash_map_key_set_real_add;
	((GeeAbstractCollectionClass *) klass)->clear = gee_hash_map_key_set_real_clear;
	((GeeAbstractCollectionClass *) klass)->remove = gee_hash_map_key_set_real_remove;
	((GeeAbstractCollectionClass *) klass)->contains = gee_hash_map_key_set_real_contains;
...
static void gee_hash_map_value_collection_class_init (GeeHashMapValueCollectionClass * klass) {
	...
	((GeeAbstractCollectionClass *) klass)->iterator = gee_hash_map_value_collection_real_iterator;
	((GeeAbstractCollectionClass *) klass)->add = gee_hash_map_value_collection_real_add;
	((GeeAbstractCollectionClass *) klass)->clear = gee_hash_map_value_collection_real_clear;
	((GeeAbstractCollectionClass *) klass)->remove = gee_hash_map_value_collection_real_remove;
	((GeeAbstractCollectionClass *) klass)->contains = gee_hash_map_value_collection_real_contains;
...
static void gee_hash_map_entry_set_class_init (GeeHashMapEntrySetClass * klass) {
	...
	((GeeAbstractCollectionClass *) klass)->iterator = gee_hash_map_entry_set_real_iterator;
	((GeeAbstractCollectionClass *) klass)->add = gee_hash_map_entry_set_real_add;
	((GeeAbstractCollectionClass *) klass)->clear = gee_hash_map_entry_set_real_clear;
	((GeeAbstractCollectionClass *) klass)->remove = gee_hash_map_entry_set_real_remove;
	((GeeAbstractCollectionClass *) klass)->contains = gee_hash_map_entry_set_real_contains;
...
static GeeHashMapNodeIterator* gee_hash_map_node_iterator_construct_from_iterator (GType object_type, GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashMapNodeIterator* iter) {
	GeeHashMapNodeIterator * self = NULL;
	GeeHashMapNodeIterator* _tmp0_ = NULL;
	GeeHashMap* _tmp1_ = NULL;
	GeeHashMap* _tmp2_ = NULL;
	GeeHashMapNodeIterator* _tmp3_ = NULL;
	gint _tmp4_ = 0;
	GeeHashMapNodeIterator* _tmp5_ = NULL;
	GeeHashMapNode* _tmp6_ = NULL;
	GeeHashMapNodeIterator* _tmp7_ = NULL;
	GeeHashMapNode* _tmp8_ = NULL;
	GeeHashMapNodeIterator* _tmp9_ = NULL;
	gint _tmp10_ = 0;
...
static GeeHashMapKeyIterator* gee_hash_map_key_iterator_construct_from_iterator (GType object_type, GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashMapKeyIterator* iter) {
	GeeHashMapKeyIterator * self = NULL;
	GeeHashMapKeyIterator* _tmp0_ = NULL;
	g_return_val_if_fail (iter != NULL, NULL);
	_tmp0_ = iter;
	self = (GeeHashMapKeyIterator*) gee_hash_map_node_iterator_construct_from_iterator (object_type, k_type, (GBoxedCopyFunc) k_dup_func, k_destroy_func, v_type, (GBoxedCopyFunc) v_dup_func, v_destroy_func, (GeeHashMapNodeIterator*) _tmp0_);
	self->priv->k_type = k_type;
	self->priv->k_dup_func = k_dup_func;
	self->priv->k_destroy_func = k_destroy_func;
	self->priv->v_type = v_type;
		...
		_tmp7_ = _tmp5_[0];
		{
			...
			i = (guint) 1;
			{
				...
				while (TRUE) {
					...
					guint _tmp13_ = 0U;
					GeeHashMapKeyIterator* _tmp14_ = NULL;
					...
					_tmp13_ = i;
					_tmp14_ = gee_hash_map_key_iterator_new_from_iterator (self->priv->k_type, (GBoxedCopyFunc) self->priv->k_dup_func, self->priv->k_destroy_func, self->priv->v_type, (GBoxedCopyFunc) self->priv->v_dup_func, self->priv->v_destroy_func, self);
...
static void gee_hash_map_key_iterator_gee_traversable_interface_init (GeeTraversableIface * iface) {
	...
	iface->tee = (GeeIterator** (*)(GeeTraversable*, guint, int*)) gee_hash_map_key_iterator_real_tee;
...
static GeeHashMapValueIterator* gee_hash_map_value_iterator_construct_from_iterator (GType object_type, GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashMapValueIterator* iter) {
	GeeHashMapValueIterator * self = NULL;
	GeeHashMapValueIterator* _tmp0_ = NULL;
	g_return_val_if_fail (iter != NULL, NULL);
	_tmp0_ = iter;
	self = (GeeHashMapValueIterator*) gee_hash_map_node_iterator_construct_from_iterator (object_type, k_type, (GBoxedCopyFunc) k_dup_func, k_destroy_func, v_type, (GBoxedCopyFunc) v_dup_func, v_destroy_func, (GeeHashMapNodeIterator*) _tmp0_);
	self->priv->k_type = k_type;
	self->priv->k_dup_func = k_dup_func;
	self->priv->k_destroy_func = k_destroy_func;
	self->priv->v_type = v_type;
		...
		_tmp7_ = _tmp5_[0];
		{
			...
			i = (guint) 1;
			{
				...
				while (TRUE) {
					...
					gint _tmp12__length1 = 0;
					guint _tmp13_ = 0U;
					GeeHashMapValueIterator* _tmp14_ = NULL;
					GeeIterator* _tmp15_ = NULL;
					if (!_tmp8_) {
						guint _tmp9_ = 0U;
						_tmp9_ = i;
					...
					_tmp12__length1 = _result__length1;
					_tmp13_ = i;
					_tmp14_ = gee_hash_map_value_iterator_new_from_iterator (self->priv->k_type, (GBoxedCopyFunc) self->priv->k_dup_func, self->priv->k_destroy_func, self->priv->v_type, (GBoxedCopyFunc) self->priv->v_dup_func, self->priv->v_destroy_func, self);
					_g_object_unref0 (_tmp12_[_tmp13_]);
					_tmp12_[_tmp13_] = (GeeIterator*) _tmp14_;
					_tmp15_ = _tmp12_[_tmp13_];
				}
...
static void gee_hash_map_value_iterator_gee_traversable_interface_init (GeeTraversableIface * iface) {
	...
	iface->tee = (GeeIterator** (*)(GeeTraversable*, guint, int*)) gee_hash_map_value_iterator_real_tee;
...
static GeeHashMapEntryIterator* gee_hash_map_entry_iterator_construct_from_iterator (GType object_type, GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GeeHashMapEntryIterator* iter) {
	GeeHashMapEntryIterator * self = NULL;
	GeeHashMapEntryIterator* _tmp0_ = NULL;
	g_return_val_if_fail (iter != NULL, NULL);
	_tmp0_ = iter;
	self = (GeeHashMapEntryIterator*) gee_hash_map_node_iterator_construct_from_iterator (object_type, k_type, (GBoxedCopyFunc) k_dup_func, k_destroy_func, v_type, (GBoxedCopyFunc) v_dup_func, v_destroy_func, (GeeHashMapNodeIterator*) _tmp0_);
	self->priv->k_type = k_type;
	self->priv->k_dup_func = k_dup_func;
	self->priv->k_destroy_func = k_destroy_func;
	self->priv->v_type = v_type;
		...
		_tmp7_ = _tmp5_[0];
		{
			...
			i = (guint) 1;
			{
				...
				while (TRUE) {
					...
					gint _tmp12__length1 = 0;
					guint _tmp13_ = 0U;
					GeeHashMapEntryIterator* _tmp14_ = NULL;
					GeeIterator* _tmp15_ = NULL;
					if (!_tmp8_) {
						guint _tmp9_ = 0U;
						_tmp9_ = i;
					...
					_tmp12__length1 = _result__length1;
					_tmp13_ = i;
					_tmp14_ = gee_hash_map_entry_iterator_new_from_iterator (self->priv->k_type, (GBoxedCopyFunc) self->priv->k_dup_func, self->priv->k_destroy_func, self->priv->v_type, (GBoxedCopyFunc) self->priv->v_dup_func, self->priv->v_destroy_func, self);
					_g_object_unref0 (_tmp12_[_tmp13_]);
					_tmp12_[_tmp13_] = (GeeIterator*) _tmp14_;
					_tmp15_ = _tmp12_[_tmp13_];
				}
...
static void gee_hash_map_entry_iterator_gee_traversable_interface_init (GeeTraversableIface * iface) {
	...
	iface->tee = (GeeIterator** (*)(GeeTraversable*, guint, int*)) gee_hash_map_entry_iterator_real_tee;
...
static void gee_hash_map_class_init (GeeHashMapClass * klass) {
	...
	((GeeAbstractMapClass *) klass)->has_key = gee_hash_map_real_has_key;
	((GeeAbstractMapClass *) klass)->has = gee_hash_map_real_has;
	((GeeAbstractMapClass *) klass)->get = gee_hash_map_real_get;
	((GeeAbstractMapClass *) klass)->set = gee_hash_map_real_set;
	((GeeAbstractMapClass *) klass)->unset = gee_hash_map_real_unset;
	((GeeAbstractMapClass *) klass)->clear = gee_hash_map_real_clear;
	((GeeAbstractMapClass *) klass)->map_iterator = gee_hash_map_real_map_iterator;
