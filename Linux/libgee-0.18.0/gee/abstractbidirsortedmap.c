/* abstractbidirsortedmap.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
static GObject * gee_abstract_bidir_sorted_map_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties);
...
static GeeBidirSortedMap* gee_abstract_bidir_sorted_map_real_get_read_only_view (GeeAbstractBidirSortedMap* base) {
	...
	_tmp1_ = instance;
	if (_tmp1_ == NULL) {
		GeeReadOnlyBidirSortedMap* _tmp2_ = NULL;
		GeeBidirSortedMap* _tmp3_ = NULL;
		_tmp2_ = gee_read_only_bidir_sorted_map_new (self->priv->k_type, (GBoxedCopyFunc) self->priv->k_dup_func, self->priv->k_destroy_func, self->priv->v_type, (GBoxedCopyFunc) self->priv->v_dup_func, self->priv->v_destroy_func, (GeeBidirSortedMap*) self);
...
static void gee_abstract_bidir_sorted_map_class_init (GeeAbstractBidirSortedMapClass * klass) {
	...
	((GeeAbstractBidirSortedMapClass *) klass)->bidir_map_iterator = gee_abstract_bidir_sorted_map_real_bidir_map_iterator;
	((GeeAbstractBidirSortedMapClass *) klass)->reserved0 = gee_abstract_bidir_sorted_map_real_reserved0;
	((GeeAbstractBidirSortedMapClass *) klass)->reserved1 = gee_abstract_bidir_sorted_map_real_reserved1;
	((GeeAbstractBidirSortedMapClass *) klass)->reserved2 = gee_abstract_bidir_sorted_map_real_reserved2;
	((GeeAbstractBidirSortedMapClass *) klass)->reserved3 = gee_abstract_bidir_sorted_map_real_reserved3;
	((GeeAbstractBidirSortedMapClass *) klass)->reserved4 = gee_abstract_bidir_sorted_map_real_reserved4;
	((GeeAbstractBidirSortedMapClass *) klass)->reserved5 = gee_abstract_bidir_sorted_map_real_reserved5;
	((GeeAbstractBidirSortedMapClass *) klass)->reserved6 = gee_abstract_bidir_sorted_map_real_reserved6;
	((GeeAbstractBidirSortedMapClass *) klass)->reserved7 = gee_abstract_bidir_sorted_map_real_reserved7;
	((GeeAbstractBidirSortedMapClass *) klass)->reserved8 = gee_abstract_bidir_sorted_map_real_reserved8;
	((GeeAbstractBidirSortedMapClass *) klass)->reserved9 = gee_abstract_bidir_sorted_map_real_reserved9;
