/* treemultimap.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
G_GNUC_INTERNAL GeeTreeMultiSet* gee_tree_multi_set_new_with_closures (GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeFunctionsCompareDataFuncClosure* compare_func);
G_GNUC_INTERNAL GeeTreeMultiSet* gee_tree_multi_set_construct_with_closures (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeFunctionsCompareDataFuncClosure* compare_func);
...
GeeTreeMultiMap* gee_tree_multi_map_construct (GType object_type, GType k_type, GBoxedCopyFunc k_dup_func, GDestroyNotify k_destroy_func, GType v_type, GBoxedCopyFunc v_dup_func, GDestroyNotify v_destroy_func, GCompareDataFunc key_compare_func, void* key_compare_func_target, GDestroyNotify key_compare_func_target_destroy_notify, GCompareDataFunc value_compare_func, void* value_compare_func_target, GDestroyNotify value_compare_func_target_destroy_notify) {
	...
	GeeFunctionsCompareDataFuncClosure* _tmp11_ = NULL;
	...
	_tmp4_ = gee_tree_map_new (k_type, (GBoxedCopyFunc) k_dup_func, k_destroy_func, GEE_TYPE_SET, (GBoxedCopyFunc) g_object_ref, g_object_unref, _tmp0_, _tmp0__target, _tmp0__target_destroy_notify, _tmp3_, _tmp1_, _tmp2_);
	_tmp5_ = _tmp4_;
	...
	_tmp10__target_destroy_notify = value_compare_func_target_destroy_notify;
	value_compare_func_target_destroy_notify = NULL;
	_tmp11_ = gee_functions_compare_data_func_closure_new (v_type, (GBoxedCopyFunc) v_dup_func, v_destroy_func, _tmp10_, _tmp10__target, _tmp10__target_destroy_notify);
	_gee_functions_compare_data_func_closure_unref0 (self->priv->_value_compare_func);
	self->priv->_value_compare_func = _tmp11_;
...
static GeeCollection* gee_tree_multi_map_real_create_value_storage (GeeAbstractMultiMap* base) {
	...
	_tmp2_ = gee_tree_set_new_with_closures (self->priv->v_type, (GBoxedCopyFunc) self->priv->v_dup_func, self->priv->v_destroy_func, _tmp1_);
...
static GeeMultiSet* gee_tree_multi_map_real_create_multi_key_set (GeeAbstractMultiMap* base) {
	...
	_tmp2_ = gee_tree_multi_set_new_with_closures (self->priv->k_type, (GBoxedCopyFunc) self->priv->k_dup_func, self->priv->k_destroy_func, _tmp1_);
...
static void gee_tree_multi_map_class_init (GeeTreeMultiMapClass * klass) {
	...
	((GeeAbstractMultiMapClass *) klass)->create_value_storage = gee_tree_multi_map_real_create_value_storage;
	((GeeAbstractMultiMapClass *) klass)->create_multi_key_set = gee_tree_multi_map_real_create_multi_key_set;
	((GeeAbstractMultiMapClass *) klass)->get_value_equal_func = gee_tree_multi_map_real_get_value_equal_func;
