/* readonlymap.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
G_GNUC_INTERNAL gboolean gee_read_only_map_contains (GeeReadOnlyMap* self, gconstpointer key);
...
G_GNUC_INTERNAL gboolean gee_read_only_map_remove (GeeReadOnlyMap* self, gconstpointer key, gpointer* value);
...
G_GNUC_INTERNAL gboolean gee_read_only_map_remove_all (GeeReadOnlyMap* self, GeeMap* map);
static gboolean gee_read_only_map_real_has_all (GeeMap* base, GeeMap* map);
gboolean gee_map_has_all (GeeMap* self, GeeMap* map);
G_GNUC_INTERNAL gboolean gee_read_only_map_contains_all (GeeReadOnlyMap* self, GeeMap* map);
...
G_GNUC_INTERNAL GType gee_read_only_map_map_iterator_get_type (void) {
 ...
 * @see Map
 */
G_GNUC_INTERNAL GType gee_read_only_map_get_type (void) {
