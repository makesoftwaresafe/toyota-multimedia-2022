/* abstractmap.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
static GeeMap* gee_abstract_map_real_get_read_only_view (GeeAbstractMap* base) {
	...
	_tmp1_ = instance;
	if (_tmp1_ == NULL) {
		GeeReadOnlyMap* _tmp2_ = NULL;
		GeeMap* _tmp3_ = NULL;
		_tmp2_ = gee_read_only_map_new (self->priv->k_type, (GBoxedCopyFunc) self->priv->k_dup_func, self->priv->k_destroy_func, self->priv->v_type, (GBoxedCopyFunc) self->priv->v_dup_func, self->priv->v_destroy_func, (GeeMap*) self);
...
static void gee_abstract_map_class_init (GeeAbstractMapClass * klass) {
	...
	((GeeAbstractMapClass *) klass)->has_key = gee_abstract_map_real_has_key;
	((GeeAbstractMapClass *) klass)->has = gee_abstract_map_real_has;
	((GeeAbstractMapClass *) klass)->get = gee_abstract_map_real_get;
	((GeeAbstractMapClass *) klass)->set = gee_abstract_map_real_set;
	((GeeAbstractMapClass *) klass)->unset = gee_abstract_map_real_unset;
	((GeeAbstractMapClass *) klass)->map_iterator = gee_abstract_map_real_map_iterator;
	((GeeAbstractMapClass *) klass)->clear = gee_abstract_map_real_clear;
	((GeeAbstractMapClass *) klass)->foreach = gee_abstract_map_real_foreach;
	((GeeAbstractMapClass *) klass)->stream = gee_abstract_map_real_stream;
	((GeeAbstractMapClass *) klass)->reserved0 = gee_abstract_map_real_reserved0;
	((GeeAbstractMapClass *) klass)->reserved1 = gee_abstract_map_real_reserved1;
	((GeeAbstractMapClass *) klass)->reserved2 = gee_abstract_map_real_reserved2;
	((GeeAbstractMapClass *) klass)->reserved3 = gee_abstract_map_real_reserved3;
	((GeeAbstractMapClass *) klass)->reserved4 = gee_abstract_map_real_reserved4;
	((GeeAbstractMapClass *) klass)->reserved5 = gee_abstract_map_real_reserved5;
	((GeeAbstractMapClass *) klass)->reserved6 = gee_abstract_map_real_reserved6;
	((GeeAbstractMapClass *) klass)->reserved7 = gee_abstract_map_real_reserved7;
	((GeeAbstractMapClass *) klass)->reserved8 = gee_abstract_map_real_reserved8;
	((GeeAbstractMapClass *) klass)->reserved9 = gee_abstract_map_real_reserved9;
