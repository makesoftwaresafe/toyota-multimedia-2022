/* abstractmultiset.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
G_GNUC_INTERNAL GeeReadOnlyMultiSet* gee_read_only_multi_set_new (GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeMultiSet* multiset);
G_GNUC_INTERNAL GeeReadOnlyMultiSet* gee_read_only_multi_set_construct (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeMultiSet* multiset);
...
static GObject * gee_abstract_multi_set_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties);
...
static gboolean gee_abstract_multi_set_real_remove (GeeAbstractCollection* base, gconstpointer item) {
	...
	if (_tmp0_) {
		...
		current_count = (gint) ((gintptr) _tmp7_);
		_tmp8_ = current_count;
		if (_tmp8_ <= 1) {
			GeeMap* _tmp9_ = NULL;
			gconstpointer _tmp10_ = NULL;
			...
			gint _tmp13_ = 0;
			_tmp11_ = self->_storage_map;
			_tmp12_ = item;
			_tmp13_ = current_count;
			gee_map_set (_tmp11_, _tmp12_, (gpointer) ((gintptr) (_tmp13_ - 1)));
		}
		_tmp14_ = self->priv->_nitems;
		self->priv->_nitems = _tmp14_ - 1;
		result = TRUE;
		return result;
	}
	result = FALSE;
...
static GeeMultiSet* gee_abstract_multi_set_real_get_read_only_view (GeeAbstractMultiSet* base) {
	...
	_tmp1_ = instance;
	if (_tmp1_ == NULL) {
		GeeReadOnlyMultiSet* _tmp2_ = NULL;
		GeeMultiSet* _tmp3_ = NULL;
		_tmp2_ = gee_read_only_multi_set_new (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, self->priv->g_destroy_func, (GeeMultiSet*) self);
...
static gboolean gee_abstract_multi_set_iterator_real_foreach (GeeTraversable* base, GeeForallFunc f, void* f_target) {
		...
		}
		{
			...
			i = _tmp8_ - 1;
			{
				...
				while (TRUE) {
					...
					_tmp15_ = _tmp12_ (_tmp14_, _tmp12__target);
					if (!_tmp15_) {
						gint _tmp16_ = 0;
						_tmp16_ = i;
						self->priv->_pending = _tmp16_;
						result = FALSE;
						return result;
					}
				}
	...
	while (TRUE) {
		...
		}
		{
			...
			i = ((gint) ((gintptr) _tmp20_)) - 1;
			{
				gboolean _tmp21_ = FALSE;
				_tmp21_ = TRUE;
				while (TRUE) {
					gint _tmp23_ = 0;
					GeeForallFunc _tmp24_ = NULL;
...
static void gee_abstract_multi_set_class_init (GeeAbstractMultiSetClass * klass) {
	...
	((GeeAbstractCollectionClass *) klass)->contains = gee_abstract_multi_set_real_contains;
	((GeeAbstractCollectionClass *) klass)->iterator = gee_abstract_multi_set_real_iterator;
	((GeeAbstractCollectionClass *) klass)->add = gee_abstract_multi_set_real_add;
	((GeeAbstractCollectionClass *) klass)->remove = gee_abstract_multi_set_real_remove;
	((GeeAbstractCollectionClass *) klass)->clear = gee_abstract_multi_set_real_clear;
	((GeeAbstractMultiSetClass *) klass)->reserved0 = gee_abstract_multi_set_real_reserved0;
	((GeeAbstractMultiSetClass *) klass)->reserved1 = gee_abstract_multi_set_real_reserved1;
	((GeeAbstractMultiSetClass *) klass)->reserved2 = gee_abstract_multi_set_real_reserved2;
	((GeeAbstractMultiSetClass *) klass)->reserved3 = gee_abstract_multi_set_real_reserved3;
	((GeeAbstractMultiSetClass *) klass)->reserved4 = gee_abstract_multi_set_real_reserved4;
	((GeeAbstractMultiSetClass *) klass)->reserved5 = gee_abstract_multi_set_real_reserved5;
	((GeeAbstractMultiSetClass *) klass)->reserved6 = gee_abstract_multi_set_real_reserved6;
	((GeeAbstractMultiSetClass *) klass)->reserved7 = gee_abstract_multi_set_real_reserved7;
	((GeeAbstractMultiSetClass *) klass)->reserved8 = gee_abstract_multi_set_real_reserved8;
