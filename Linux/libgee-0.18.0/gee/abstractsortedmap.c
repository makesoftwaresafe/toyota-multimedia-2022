/* abstractsortedmap.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
static GObject * gee_abstract_sorted_map_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties);
...
static GeeSortedMap* gee_abstract_sorted_map_real_get_read_only_view (GeeSortedMap* base) {
	...
	_tmp1_ = instance;
	if (_tmp1_ == NULL) {
		GeeReadOnlySortedMap* _tmp2_ = NULL;
		GeeSortedMap* _tmp3_ = NULL;
		_tmp2_ = gee_read_only_sorted_map_new (self->priv->k_type, (GBoxedCopyFunc) self->priv->k_dup_func, self->priv->k_destroy_func, self->priv->v_type, (GBoxedCopyFunc) self->priv->v_dup_func, self->priv->v_destroy_func, (GeeMap*) self);
...
static void gee_abstract_sorted_map_class_init (GeeAbstractSortedMapClass * klass) {
	...
	((GeeAbstractSortedMapClass *) klass)->head_map = gee_abstract_sorted_map_real_head_map;
	((GeeAbstractSortedMapClass *) klass)->tail_map = gee_abstract_sorted_map_real_tail_map;
	((GeeAbstractSortedMapClass *) klass)->sub_map = gee_abstract_sorted_map_real_sub_map;
	((GeeAbstractSortedMapClass *) klass)->reserved0 = gee_abstract_sorted_map_real_reserved0;
	((GeeAbstractSortedMapClass *) klass)->reserved1 = gee_abstract_sorted_map_real_reserved1;
	((GeeAbstractSortedMapClass *) klass)->reserved2 = gee_abstract_sorted_map_real_reserved2;
	((GeeAbstractSortedMapClass *) klass)->reserved3 = gee_abstract_sorted_map_real_reserved3;
	((GeeAbstractSortedMapClass *) klass)->reserved4 = gee_abstract_sorted_map_real_reserved4;
	((GeeAbstractSortedMapClass *) klass)->reserved5 = gee_abstract_sorted_map_real_reserved5;
	((GeeAbstractSortedMapClass *) klass)->reserved6 = gee_abstract_sorted_map_real_reserved6;
	((GeeAbstractSortedMapClass *) klass)->reserved7 = gee_abstract_sorted_map_real_reserved7;
	((GeeAbstractSortedMapClass *) klass)->reserved8 = gee_abstract_sorted_map_real_reserved8;
	((GeeAbstractSortedMapClass *) klass)->reserved9 = gee_abstract_sorted_map_real_reserved9;
