/* abstractmultimap.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
static gboolean ___lambda45_ (Block2Data* _data2_, gpointer v);
static gboolean ____lambda45__gee_forall_func (gpointer g, gpointer self);
gboolean gee_map_iterator_foreach (GeeMapIterator* self, GeeForallMapFunc f, void* f_target);
static gboolean __lambda46_ (Block1Data* _data1_, gconstpointer key, GeeCollection* col);
static Block3Data* block3_data_ref (Block3Data* _data3_);
static void block3_data_unref (void * _userdata_);
static gboolean __lambda47_ (Block3Data* _data3_, gpointer v);
static gboolean ___lambda47__gee_forall_func (gpointer g, gpointer self);
static gboolean ___lambda46__gee_forall_map_func (gconstpointer k, gconstpointer v, gpointer self);
...
static gboolean __lambda48_ (Block4Data* _data4_, gconstpointer key, GeeCollection* col);
static gboolean ___lambda48__gee_forall_map_func (gconstpointer k, gconstpointer v, gpointer self);
...
static GeeMultiMap* gee_abstract_multi_map_real_get_read_only_view (GeeAbstractMultiMap* base) {
	...
	_tmp1_ = instance;
	if (_tmp1_ == NULL) {
		GeeReadOnlyMultiMap* _tmp2_ = NULL;
		GeeMultiMap* _tmp3_ = NULL;
		_tmp2_ = gee_read_only_multi_map_new (self->priv->k_type, (GBoxedCopyFunc) self->priv->k_dup_func, self->priv->k_destroy_func, self->priv->v_type, (GBoxedCopyFunc) self->priv->v_dup_func, self->priv->v_destroy_func, (GeeMultiMap*) self);
...
static void gee_abstract_multi_map_all_keys_class_init (GeeAbstractMultiMapAllKeysClass * klass) {
	...
	((GeeAbstractCollectionClass *) klass)->iterator = gee_abstract_multi_map_all_keys_real_iterator;
	((GeeAbstractCollectionClass *) klass)->contains = gee_abstract_multi_map_all_keys_real_contains;
	((GeeAbstractCollectionClass *) klass)->add = gee_abstract_multi_map_all_keys_real_add;
	((GeeAbstractCollectionClass *) klass)->remove = gee_abstract_multi_map_all_keys_real_remove;
	((GeeAbstractCollectionClass *) klass)->clear = gee_abstract_multi_map_all_keys_real_clear;
...
static void gee_abstract_multi_map_values_class_init (GeeAbstractMultiMapValuesClass * klass) {
	...
	((GeeAbstractCollectionClass *) klass)->iterator = gee_abstract_multi_map_values_real_iterator;
	((GeeAbstractCollectionClass *) klass)->contains = gee_abstract_multi_map_values_real_contains;
	((GeeAbstractCollectionClass *) klass)->add = gee_abstract_multi_map_values_real_add;
	((GeeAbstractCollectionClass *) klass)->remove = gee_abstract_multi_map_values_real_remove;
	((GeeAbstractCollectionClass *) klass)->clear = gee_abstract_multi_map_values_real_clear;
...
static gboolean __lambda46_ (Block1Data* _data1_, gconstpointer key, GeeCollection* col) {
	...
	_data3_->key = _tmp1_;
	_tmp2_ = col;
	_tmp3_ = gee_traversable_foreach ((GeeTraversable*) _tmp2_, ___lambda47__gee_forall_func, _data3_);
	result = _tmp3_;
...
static gboolean ___lambda46__gee_forall_map_func (gconstpointer k, gconstpointer v, gpointer self) {
	gboolean result;
	result = __lambda46_ (self, k, (GeeCollection*) v);
	return result;
}
...
static gboolean gee_abstract_multi_map_key_iterator_real_foreach (GeeTraversable* base, GeeForallFunc f, void* f_target) {
	...
	if (_tmp1_) {
		...
		_tmp9_ = gee_traversable_foreach ((GeeTraversable*) _tmp8_, ____lambda45__gee_forall_func, _data2_);
		if (!_tmp9_) {
			result = FALSE;
	...
	_tmp12_ = gee_map_iterator_foreach (_tmp11_, ___lambda46__gee_forall_map_func, _data1_);
	result = _tmp12_;
	block1_data_unref (_data1_);
	_data1_ = NULL;
	return result;
...
static gboolean ___lambda48__gee_forall_map_func (gconstpointer k, gconstpointer v, gpointer self) {
	gboolean result;
	result = __lambda48_ (self, k, (GeeCollection*) v);
	return result;
}
...
static gboolean gee_abstract_multi_map_value_iterator_real_foreach (GeeTraversable* base, GeeForallFunc f, void* f_target) {
	...
	_tmp10_ = ((GeeAbstractMultiMapMappingIterator*) self)->outer;
	_tmp11_ = gee_map_iterator_foreach (_tmp10_, ___lambda48__gee_forall_map_func, _data4_);
	result = _tmp11_;
	block4_data_unref (_data4_);
	_data4_ = NULL;
	return result;
...
static void gee_abstract_multi_map_class_init (GeeAbstractMultiMapClass * klass) {
	...
	((GeeAbstractMultiMapClass *) klass)->create_value_storage = gee_abstract_multi_map_real_create_value_storage;
	((GeeAbstractMultiMapClass *) klass)->create_multi_key_set = gee_abstract_multi_map_real_create_multi_key_set;
	((GeeAbstractMultiMapClass *) klass)->get_value_equal_func = gee_abstract_multi_map_real_get_value_equal_func;
	((GeeAbstractMultiMapClass *) klass)->reserved0 = gee_abstract_multi_map_real_reserved0;
	((GeeAbstractMultiMapClass *) klass)->reserved1 = gee_abstract_multi_map_real_reserved1;
	((GeeAbstractMultiMapClass *) klass)->reserved2 = gee_abstract_multi_map_real_reserved2;
	((GeeAbstractMultiMapClass *) klass)->reserved3 = gee_abstract_multi_map_real_reserved3;
	((GeeAbstractMultiMapClass *) klass)->reserved4 = gee_abstract_multi_map_real_reserved4;
	((GeeAbstractMultiMapClass *) klass)->reserved5 = gee_abstract_multi_map_real_reserved5;
	((GeeAbstractMultiMapClass *) klass)->reserved6 = gee_abstract_multi_map_real_reserved6;
	((GeeAbstractMultiMapClass *) klass)->reserved7 = gee_abstract_multi_map_real_reserved7;
	((GeeAbstractMultiMapClass *) klass)->reserved8 = gee_abstract_multi_map_real_reserved8;
