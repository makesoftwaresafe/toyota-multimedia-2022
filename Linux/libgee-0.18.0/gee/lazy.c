/* lazy.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
GeeFuture* gee_lazy_get_future (GeeLazy* self) {
	GeeFuture* result;
	GeeLazyFuture* _tmp0_ = NULL;
	g_return_val_if_fail (self != NULL, NULL);
	_tmp0_ = gee_lazy_future_new (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, self->priv->g_destroy_func, self);
...
static void gee_lazy_future_real_wait_async (GeeFuture* base, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_async_result = g_simple_async_result_new (G_OBJECT (self), _callback_, _user_data_, gee_lazy_future_real_wait_async);
	g_simple_async_result_set_op_res_gpointer (_data_->_async_result, _data_, gee_lazy_future_real_wait_async_data_free);
...
static void gee_lazy_future_do_eval (GeeLazyFuture* self) {
	GeeLazy* _tmp0_ = NULL;
	GeeLazy* _tmp1_ = NULL;
	GeeLazyFunc _tmp2_ = NULL;
	void* _tmp2__target = NULL;
	gpointer _tmp3_ = NULL;
	GeeLazy* _tmp4_ = NULL;
	GeeFutureSourceFuncArrayElement* when_done = NULL;
	GeeFutureSourceFuncArrayElement* _tmp5_ = NULL;
	...
	_when_done_size_ = when_done_length1;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				gint _tmp8_ = 0;
				GeeFutureSourceFuncArrayElement* _tmp9_ = NULL;
				gint _tmp9__length1 = 0;
				GeeFutureSourceFuncArrayElement* _tmp10_ = NULL;
				gint _tmp10__length1 = 0;
				gint _tmp11_ = 0;
				GeeFutureSourceFuncArrayElement _tmp12_ = {0};
...
static void gee_lazy_future_class_init (GeeLazyFutureClass * klass) {
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), GEE_LAZY_FUTURE_READY, g_param_spec_boolean ("ready", "ready", "ready", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	g_object_class_install_property (G_OBJECT_CLASS (klass), GEE_LAZY_FUTURE_EXCEPTION, g_param_spec_pointer ("exception", "exception", "exception", G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
}
...
static void gee_lazy_future_gee_future_interface_init (GeeFutureIface * iface) {
	...
	iface->wait_async = (gconstpointer (*)(GeeFuture*, GError**)) gee_lazy_future_real_wait_async;
	iface->wait_finish = gee_lazy_future_real_wait_finish;
