/* readonlysortedmap.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
enum  {
	...
	GEE_READ_ONLY_SORTED_MAP_READ_ONLY_VIEW
};
...
static GeeSortedMap* gee_read_only_sorted_map_real_get_read_only_view (GeeSortedMap* base) {
	GeeSortedMap* result;
	GeeReadOnlySortedMap* self;
...
static void gee_read_only_sorted_map_class_init (GeeReadOnlySortedMapClass * klass) {
	 ...
	 * {@inheritDoc}
	 */
	g_object_class_install_property (G_OBJECT_CLASS (klass), GEE_READ_ONLY_SORTED_MAP_READ_ONLY_VIEW, g_param_spec_object ("read-only-view", "read-only-view", "read-only-view", GEE_TYPE_SORTED_MAP, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
}
 ...
 * @see SortedMap
 */
G_GNUC_INTERNAL GType gee_read_only_sorted_map_get_type (void) {
...
static void _vala_gee_read_only_sorted_map_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec) {
	...
	switch (property_id) {
		...
		break;
		case GEE_READ_ONLY_SORTED_MAP_READ_ONLY_VIEW:
