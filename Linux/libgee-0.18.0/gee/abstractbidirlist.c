/* abstractbidirlist.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
G_GNUC_INTERNAL GeeReadOnlyBidirList* gee_read_only_bidir_list_new (GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeBidirList* list);
G_GNUC_INTERNAL GeeReadOnlyBidirList* gee_read_only_bidir_list_construct (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeBidirList* list);
...
static GObject * gee_abstract_bidir_list_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties);
...
static GeeBidirList* gee_abstract_bidir_list_real_get_read_only_view (GeeAbstractBidirList* base) {
	...
	_tmp1_ = instance;
	if (_tmp1_ == NULL) {
		GeeReadOnlyBidirList* _tmp2_ = NULL;
		GeeBidirList* _tmp3_ = NULL;
		_tmp2_ = gee_read_only_bidir_list_new (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, self->priv->g_destroy_func, (GeeBidirList*) self);
...
static void gee_abstract_bidir_list_class_init (GeeAbstractBidirListClass * klass) {
	...
	((GeeAbstractBidirListClass *) klass)->bidir_list_iterator = gee_abstract_bidir_list_real_bidir_list_iterator;
	((GeeAbstractBidirListClass *) klass)->reserved0 = gee_abstract_bidir_list_real_reserved0;
	((GeeAbstractBidirListClass *) klass)->reserved1 = gee_abstract_bidir_list_real_reserved1;
	((GeeAbstractBidirListClass *) klass)->reserved2 = gee_abstract_bidir_list_real_reserved2;
	((GeeAbstractBidirListClass *) klass)->reserved3 = gee_abstract_bidir_list_real_reserved3;
	((GeeAbstractBidirListClass *) klass)->reserved4 = gee_abstract_bidir_list_real_reserved4;
	((GeeAbstractBidirListClass *) klass)->reserved5 = gee_abstract_bidir_list_real_reserved5;
	((GeeAbstractBidirListClass *) klass)->reserved6 = gee_abstract_bidir_list_real_reserved6;
	((GeeAbstractBidirListClass *) klass)->reserved7 = gee_abstract_bidir_list_real_reserved7;
	((GeeAbstractBidirListClass *) klass)->reserved8 = gee_abstract_bidir_list_real_reserved8;
	((GeeAbstractBidirListClass *) klass)->reserved9 = gee_abstract_bidir_list_real_reserved9;
