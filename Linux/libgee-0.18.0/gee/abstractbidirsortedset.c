/* abstractbidirsortedset.c generated by valac 0.27.1.26-9b1a5, the Vala compiler
...
static GObject * gee_abstract_bidir_sorted_set_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties);
...
static GeeBidirSortedSet* gee_abstract_bidir_sorted_set_real_get_read_only_view (GeeAbstractBidirSortedSet* base) {
	...
	_tmp1_ = instance;
	if (_tmp1_ == NULL) {
		GeeReadOnlyBidirSortedSet* _tmp2_ = NULL;
		GeeBidirSortedSet* _tmp3_ = NULL;
		_tmp2_ = gee_read_only_bidir_sorted_set_new (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, self->priv->g_destroy_func, (GeeBidirSortedSet*) self);
...
static void gee_abstract_bidir_sorted_set_class_init (GeeAbstractBidirSortedSetClass * klass) {
	...
	((GeeAbstractBidirSortedSetClass *) klass)->bidir_iterator = gee_abstract_bidir_sorted_set_real_bidir_iterator;
	((GeeAbstractBidirSortedSetClass *) klass)->reserved0 = gee_abstract_bidir_sorted_set_real_reserved0;
	((GeeAbstractBidirSortedSetClass *) klass)->reserved1 = gee_abstract_bidir_sorted_set_real_reserved1;
	((GeeAbstractBidirSortedSetClass *) klass)->reserved2 = gee_abstract_bidir_sorted_set_real_reserved2;
	((GeeAbstractBidirSortedSetClass *) klass)->reserved3 = gee_abstract_bidir_sorted_set_real_reserved3;
	((GeeAbstractBidirSortedSetClass *) klass)->reserved4 = gee_abstract_bidir_sorted_set_real_reserved4;
	((GeeAbstractBidirSortedSetClass *) klass)->reserved5 = gee_abstract_bidir_sorted_set_real_reserved5;
	((GeeAbstractBidirSortedSetClass *) klass)->reserved6 = gee_abstract_bidir_sorted_set_real_reserved6;
	((GeeAbstractBidirSortedSetClass *) klass)->reserved7 = gee_abstract_bidir_sorted_set_real_reserved7;
	((GeeAbstractBidirSortedSetClass *) klass)->reserved8 = gee_abstract_bidir_sorted_set_real_reserved8;
	((GeeAbstractBidirSortedSetClass *) klass)->reserved9 = gee_abstract_bidir_sorted_set_real_reserved9;
