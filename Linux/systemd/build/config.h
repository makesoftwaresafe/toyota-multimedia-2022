...
#define CANONICAL_HOST "x86_64-mel-linux-gnu"
...
/* Define if the ACL for adm group should be enabled */
...
/* Define to 1 if you have the declaration of `copy_file_range', and to 0 if
   you don't. */
#define HAVE_DECL_COPY_FILE_RANGE 0
...
/* Define to 1 if you have the declaration of `IFLA_BRPORT_PROXYARP', and to 0
   if you don't. */
#define HAVE_DECL_IFLA_BRPORT_PROXYARP 1

/* Define to 1 if you have the declaration of `IFLA_BR_VLAN_DEFAULT_PVID', and
   to 0 if you don't. */
...
/* nss-myhostname is enabled */
/* #undef HAVE_MYHOSTNAME */
...
/* Default KillUserProcesses setting */
#define KILL_USER_PROCESSES true
