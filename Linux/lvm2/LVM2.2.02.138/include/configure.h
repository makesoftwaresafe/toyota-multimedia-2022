...
#define DEFAULT_SPARSE_SEGTYPE "snapshot"
...
#define DMEVENTD_PATH "/usr/sbin/dmeventd"

/* Path to dmeventd pidfile. */
#define DMEVENTD_PIDFILE "/run/dmeventd.pid"
...
/* Library version */
#define DM_LIB_VERSION "1.02.114 (2015-12-14)"
...
#define LVMETAD_PIDFILE "/run/lvmetad.pid"

/* Define to 1 to include code that uses lvmetad. */
#define LVMETAD_SUPPORT 1
