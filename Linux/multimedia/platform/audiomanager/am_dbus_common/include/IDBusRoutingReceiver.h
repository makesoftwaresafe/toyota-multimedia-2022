 ...
 */
class IDBusRoutingReceiver: public IAmRoutingReceive
{
public:
    IDBusRoutingReceiver(DBusConnection *DbusConnection, const std::string& interface, const std::string application = "");
    virtual ~IDBusRoutingReceiver();
