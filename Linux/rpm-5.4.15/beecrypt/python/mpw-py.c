...
{
fprintf(stderr, "%5.5s %p[%d]:\t", msg, MPW_DATA(x), (int)MPW_SIZE(x)), mpfprintln(stderr, MPW_SIZE(x), MPW_DATA(x));
}
...
if (_mpw_debug < -1)
fprintf(stderr, "*** mpstr(%p[%d], %p[%d], %d):\t", t, (int)nt, data, (int)size, (int)base), mpfprintln(stderr, size, data);
...
if (_mpw_debug < -1) {
fprintf(stderr, "    a %p[%d]:\t", adata, (int)asize), mpfprintln(stderr, asize, adata);
fprintf(stderr, "    z %p[%d]:\t", zdata, (int)asize+1), mpfprintln(stderr, asize+1, zdata);
}
	result = zdata[asize];
	t[nt] = bchars[result];
...
if (_mpw_debug < -1)
fprintf(stderr, "*** mpw_format(%p,%d,%d):\t", z, (int)base, addL), mpfprintln(stderr, zsize, zdata);
...
if (_mpw_debug)
fprintf(stderr, "*** mpw_%s %p[%d]\t", fname, MPW_DATA(z), (int)MPW_SIZE(z)), mpfprintln(stderr, MPW_SIZE(z), MPW_DATA(z));
...
if (_mpw_debug < 0) {
fprintf(stderr, "    a %p[%d]:\t", adata, (int)asize), mpfprintln(stderr, asize, adata);
fprintf(stderr, "    b %p[%d]:\t", bdata, (int)bsize), mpfprintln(stderr, bsize, bdata);
fprintf(stderr, "    z %p[%d]:\t", zdata, (int)zsize), mpfprintln(stderr, zsize, zdata);
}
...
fprintf(stderr, "*** mpw_neg %p[%d]\t", MPW_DATA(z), (int)MPW_SIZE(z)), mpfprintln(stderr, MPW_SIZE(z), MPW_DATA(z));
...
if (z != NULL && _mpw_debug)
fprintf(stderr, "*** mpw_pos %p[%d]\t", MPW_DATA(z), (int)MPW_SIZE(z)), mpfprintln(stderr, MPW_SIZE(z), MPW_DATA(z));
...
if (z != NULL && _mpw_debug)
fprintf(stderr, "*** mpw_abs %p[%d]\t", MPW_DATA(z), (int)MPW_SIZE(z)), mpfprintln(stderr, MPW_SIZE(z), MPW_DATA(z));
