...
if (_rng_debug)
fprintf(stderr, "*** rng_Next(%p) %p[%d]\t", s, MPW_DATA(z), (int)MPW_SIZE(z)), mpfprintln(stderr, MPW_SIZE(z), MPW_DATA(z));
...
fprintf(stderr, "*** rng_Prime(%p) %p[%d]\t", s, MPW_DATA(z), (int)MPW_SIZE(z)), mpfprintln(stderr, MPW_SIZE(z), MPW_DATA(z));
