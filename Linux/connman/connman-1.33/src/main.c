...
static gchar *option_wpaconfig = NULL;
...
static GOptionEntry options[] = {
	...
	{ "wpaconfigfile", 'w', 0, G_OPTION_ARG_STRING, &option_wpaconfig,
				"Specify the wpa configuration file to be used to create dynamic interface",
				"FILE"},
	{ NULL },
};
...
const char *connman_option_get_string(const char *key)
{
	...
	else if (g_strcmp0(key, "wpaconfigfile") == 0) {
		return option_wpaconfig;
	}
	return NULL;
}
