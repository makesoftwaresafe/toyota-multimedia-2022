...
#
equals(QT_MAJOR_VERSION, 5): load(qt_build_config)
#
...
win32 { 
    QMAKE_PRE_LINK = copy /y $$toSystemPath($${ROOT_BUILD_DIR}/Source/WebKit/release/*.lib) $$toSystemPath($${ROOT_BUILD_DIR}/lib)
} 