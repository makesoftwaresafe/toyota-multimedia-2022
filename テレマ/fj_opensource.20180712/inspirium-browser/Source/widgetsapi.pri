...
haveQt(5): QT += network widgets widgets-private
else : QT += network
...
QT += webkit
#
!haveQt(5):LIBS += -L$${ROOT_WEBKIT_DIR}/WebKitBuild/Release/Source/release/ -lQtWebKit
#
...
# 
# append DefaultFullScreenVideoHandler.* to SOURCES/HEADERS
# when we use QT_MULTIMEDIA.
use?(QT_MULTIMEDIA) {
	SOURCES += \
...
win32 { 
    QMAKE_PRE_LINK = copy /y $$toSystemPath($$PWD/WebKit/qt/lib/Qt5WebKit.lib) $$toSystemPath($${ROOT_BUILD_DIR}/lib)
} 
