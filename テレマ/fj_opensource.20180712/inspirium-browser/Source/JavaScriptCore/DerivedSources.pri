...
INSPECTOR_DOMAINS = \
    $$PWD/inspector/protocol/Console.json \
    $$PWD/inspector/protocol/Debugger.json \
    $$PWD/inspector/protocol/GenericTypes.json \
    $$PWD/inspector/protocol/InspectorDomain.json \
    $$PWD/inspector/protocol/Runtime.json

INJECTED_SCRIPT_SOURCE = $$PWD/inspector/InjectedScriptSource.js

INSPECTOR_JSON = $$PWD/inspector/scripts/CodeGeneratorInspectorStrings.py 
...
inspectorJS.output = InspectorJS.json
inspectorJS.input =  INSPECTOR_DOMAINS
inspectorJS.script = $$PWD/inspector/scripts/generate-combined-inspector-json.py
inspectorJS.commands = python $$PWD/inspector/scripts/generate-combined-inspector-json.py $$PWD/inspector/protocol > ${QMAKE_FILE_OUT}
inspectorJS.depends = $$INSPECTOR_DOMAINS $$PWD/inspector/scripts/generate-combined-inspector-json.py
inspectorJS.add_output_to_sources = false
GENERATORS += inspectorJS 

# Inspector Backend Dispatchers, Frontend Dispatchers, Type Builders
inspectorJSON.output = InspectorJSBackendDispatchers.cpp InspectorJSBackendDispatchers.h InspectorJSFrontendDispatchers.cpp InspectorJSFrontendDispatchers.h InspectorJSTypeBuilders.cpp InspectorJSTypeBuilders.h
inspectorJSON.input = INSPECTOR_JSON
inspectorJSON.script = $$PWD/inspector/scripts/CodeGeneratorInspector.py
inspectorJSON.commands = python $$toSystemPath($$PWD/inspector/scripts/CodeGeneratorInspector.py) ${QMAKE_FUNC_FILE_OUT_PATH}/InspectorJS.json --output_h_dir ${QMAKE_FUNC_FILE_OUT_PATH} --output_cpp_dir ${QMAKE_FUNC_FILE_OUT_PATH} --output_js_dir ${QMAKE_FUNC_FILE_OUT_PATH} --output_type JavaScript --write_always && $$QMAKE_MKDIR $$toSystemPath(${QMAKE_FUNC_FILE_OUT_PATH}/inspector) && $$QMAKE_COPY $$toSystemPath(${QMAKE_FUNC_FILE_OUT_PATH}/InspectorJSBackendDispatchers.h) $$toSystemPath(${QMAKE_FUNC_FILE_OUT_PATH}/inspector) && $$QMAKE_COPY $$toSystemPath(${QMAKE_FUNC_FILE_OUT_PATH}/InspectorJSFrontendDispatchers.h) $$toSystemPath(${QMAKE_FUNC_FILE_OUT_PATH}/inspector) && $$QMAKE_COPY $$toSystemPath(${QMAKE_FUNC_FILE_OUT_PATH}/InspectorJSTypeBuilders.h) $$toSystemPath(${QMAKE_FUNC_FILE_OUT_PATH}/inspector)
inspectorJSON.depends = $$PWD/inspector/scripts/CodeGeneratorInspector.py ${QMAKE_FUNC_FILE_OUT_PATH}/InspectorJS.json $$PWD/inspector/scripts/CodeGeneratorInspectorStrings.py
GENERATORS += inspectorJSON

# inspector injected script source compiler
injectedScriptSource.output = InjectedScriptSource.h
injectedScriptSource.input = INJECTED_SCRIPT_SOURCE
injectedScriptSource.commands = python $$PWD/inspector/scripts/jsmin.py <${QMAKE_FILE_IN} > ${QMAKE_FUNC_FILE_OUT_PATH}/InjectedScriptSource.min.js && perl $$PWD/inspector/scripts/xxd.pl InjectedScriptSource_js ${QMAKE_FUNC_FILE_OUT_PATH}/InjectedScriptSource.min.js ${QMAKE_FILE_OUT}
...
GENERATORS += injectedScriptSource
	...
	if(android) {
	    EXTRACTOR_BINARY = libLLIntOffsetsExtractor.so
	} else {
