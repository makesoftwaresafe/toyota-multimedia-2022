...
void QGraphicsWebView::forceGC()
{
    WebCore::gcController().garbageCollectNow();
}

bool QGraphicsWebView::testBaseElementCanRender(QGraphicsWebView::BaseElementType type)
{
	return page()->d->mainFrameAdapter()->testBaseElementCanRender(static_cast<QWebFrameAdapter::BaseElementType>(type));
}
