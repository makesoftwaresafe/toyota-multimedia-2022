...
/**/
    //add for cookie
    void deleteCookie(const QUrl& url, const QString& name);
    void deleteAllCookies();
    void deleteCookiesByHostname(const QString& hostname);
/**/

    void forceGC();
	bool testBaseElementCanRender(BaseElementType type);
