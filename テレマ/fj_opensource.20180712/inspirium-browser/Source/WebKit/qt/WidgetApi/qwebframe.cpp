...
{
    if(!d->testBaseElementCanRender( static_cast<QWebFrameAdapter::BaseElementType>(QWebFrameAdapter::BaseElementType::HTMLElement | QWebFrameAdapter::BaseElementType::BodyElement) ))
    {
