...
#if ENABLE(FJIB_PDF)
    //PDF API    
    virtual void showPDFErrorAlert(QWebFrameAdapter*, int errorcode, const QString& msg) override;
    virtual bool requirePDFPasswordPrompt(QWebFrameAdapter*, const QString& msg, const QString& defaultValue, QString* result) override;
#endif
...
/**/
    virtual void bindingGeolocationPositionSource(GeolocationPositionSource*) override;
/**/

#if ENABLE(MEDIA_STREAM)
    virtual void requestUserMediaPermission(PassRefPtr<WebCore::UserMediaRequest>) override;
#endif
    ...
    virtual void yield(YieldReason reason) override;
