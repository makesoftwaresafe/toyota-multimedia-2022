...
class QSpeechSynthesizer;

/**/
class GeolocationPositionSource;
...
namespace WebCore {
	...
	class NetworkInformationClient;
	class SpeechRecognitionClient;
	class SpeechSynthesizerController;
...
/**/
    void setLocalStorageMaxSize(unsigned bytes);
    unsigned localStorageMaxSize();
    void clearLocalStorage();
    void removeStorageItem(const QString& itemName);
    void deleteLocalStorage();
    void setCrashCallback(HookFunction crashHookFunction);
/**/
...
//--
    ...
    enum GSTPermissionType {
        Allow,
        Disallow
    };

    bool handleGSTConnection(GSTMediaType type, GSTPermissionType permission =  Allow);
//--
...
/**/
    virtual void setGpsInfo(const GpsInfo& gpsInfo);
    virtual GpsInfo getGpsInfo() const;
/**/

	void setVehicle(QVehicle* vehicle);
	void setQAMBInterface(QAMBInterface* ambInterface);

	void setQNetworkInfoInterface(QNetworkInfo* qNetworkInfo);
	void setQSpeechRecognitionInterface(QSpeechRecognition* qSpeechRecog);
	void setQSpeechSynthesizerInterface(QSpeechSynthesizer* qSpeechSynth);
    ...
    virtual void yield(YieldReason reason);
...
/**/
    ...
    void userMediaPermissionRequested(QWebPage::Feature);

/**/
    void getGeolocationPosition();
    void positionUpdated(const QString&, const QString&, const QString&,
...
protected:
    ...
    //PDF API
    virtual void showPDFErrorAlert(QWebFrame *originatingFrame, int errorcode, const QString& msg);
    virtual bool requirePDFPasswordPrompt(QWebFrame *originatingFrame, const QString& msg, const QString& defaultValue, QString* result);

    virtual QString userAgentForUrl(const QUrl& url) const;
    void bindingGeolocationPositionSource(GeolocationPositionSource* geoSource);
