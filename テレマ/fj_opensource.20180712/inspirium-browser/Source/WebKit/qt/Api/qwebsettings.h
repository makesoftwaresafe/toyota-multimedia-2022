...
/**/
    void setSendReferer(bool referer);
    bool sendReferer();

    static void setTimeOut(const unsigned long timeout);
    static unsigned long timeOut();

    static void setSynchronousTimeout(unsigned long timeout);
    static unsigned long synchronousTimeout();

    static void setCookiePath(const QString& path);
    static const QString& cookiePath();
    static void setCookieSize(const unsigned long cookieSize);
    static unsigned long cookieSize();	

    void setApplicationCacheMaxSize(int64_t size);
    int64_t applicationCacheMaxSize();
    void clearApplicationCache();
    void deleteOfflineWebApplicationCacheFiles();
	...
	void setPlatformNPPValues(QVector<QNPPValue> values);
	QVector<QNPPValue>& platformNPPValues();
/**/
...
/**/
    void setAboutBlankBackGroundColor(quint8 red, quint8 green, quint8 blue);
    quint32 aboutBlankBackGroundColor();
    
    void setEnableInputFileDialog(bool on);
    bool enableInputFileDialog();

    void setShouldDisplayCaptions(bool enabled);
    bool shouldDisplayCaptions();

    void setShouldDisplaySubtitles(bool enabled);
    bool shouldDisplaySubtitles();

    void setShouldDisplayTextDescriptions(bool enabled);
...
/**/
    ...
    static void setPDFToolBarHTMLSource(const QString& html);
    static QString pdfToolBarHTMLSource();
    ...
    static void setICUDataPath(const QString& path);
    static const QString icuDataPath();
#endif

	void setPopupMenuSupport(bool);
	bool popupMenuSupport();

#if defined WTF_USE_V8 && WTF_USE_V8
    static void setV8Flags(WebKit::V8Feature feature, bool value);
    static void setV8Flags(WebKit::V8Feature feature, int value);
    static void setV8Flags(WebKit::V8Feature feature, const char* value);
#endif
