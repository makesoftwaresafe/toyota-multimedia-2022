...
#if ENABLE(FJIB_PDF)
    ,PDFDocumentClass = 1 << 7
#endif
};

typedef unsigned char DocumentClassFlags;

class WEBCORE_API Document : public ContainerNode, public TreeScope, public ScriptExecutionContext {
public:
...
#if ENABLE(FJIB_PDF)
    bool isPDFDocument() const { return m_documentClasses & PDFDocumentClass; }
#endif
