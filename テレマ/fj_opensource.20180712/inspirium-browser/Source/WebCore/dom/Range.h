...
public:
    ...
    WEBCORE_API Node* startContainer(ExceptionCode&) const;
    WEBCORE_API int startOffset(ExceptionCode&) const;
    WEBCORE_API Node* endContainer(ExceptionCode&) const;
    WEBCORE_API int endOffset(ExceptionCode&) const;
    ...
    WEBCORE_API String toHTML() const;
    String text() const;
