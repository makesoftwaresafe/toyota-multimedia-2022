...
public:
    static WEBCORE_EXPORTDATA PassRefPtr<CSSComputedStyleDeclaration> create(PassRefPtr<Node> node, bool allowVisitedStyle = false, const String& pseudoElementName = String())
    {
    ...
    WEBCORE_EXPORTDATA String getPropertyValue(CSSPropertyID) const;

private:
    WEBCORE_EXPORTDATA CSSComputedStyleDeclaration(PassRefPtr<Node>, bool allowVisitedStyle, const String&);
