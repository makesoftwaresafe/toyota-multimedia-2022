...
/**/
#if OS(WINCE)
//#define BUILDING_WEBKIT_LIB
#ifdef BUILDING_WEBKIT_LIB
#define WEBKIT_API
#define WEBCORE_API
#else //BUILDING_WEBKIT_LIB
#ifdef BUILDING_WEBKIT_DLL
#define WEBKIT_API __declspec(dllexport)
#define WEBCORE_API __declspec(dllexport)
#else //BUILDING_WEBKIT_DLL
#define WEBKIT_API __declspec(dllimport)
#define WEBCORE_API __declspec(dllimport)
#endif //BUILDING_WEBKIT_DLL
#endif //BUILDING_WEBKIT_LIB
#elif PLATFORM(QT) && defined(_MSC_VER)
#if defined(BUILDING_WebCore)
#define WEBCORE_API __declspec(dllexport)
#else
#define WEBCORE_API __declspec(dllimport)
#endif //defined(BUILDING_WebCore)
#else
#define WEBKIT_API
#define WEBCORE_API
#endif //OS(WINCE)
