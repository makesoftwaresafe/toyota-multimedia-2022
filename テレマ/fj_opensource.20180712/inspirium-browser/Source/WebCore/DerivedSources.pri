...
WebCore_INSPECTOR_SCRIPTS_DIR = $$PWD/../JavaScriptCore/inspector/scripts

INSPECTORUI_LOCALIZEDSTRINGS_SOURCE_DIR = $$PWD/../WebInspectorUI/Localizations/en.lproj/localizedStrings.js

INSPECTORUI_LOCALIZEDSTRINGS_TARGET_DIR = $$PWD/../WebInspectorUI/UserInterface/Localizations/en.lproj

INSPECTOR_WEB_DOMAINS = \
    $$PWD/inspector/protocol/ApplicationCache.json \
    $$PWD/inspector/protocol/Canvas.json \
    $$PWD/inspector/protocol/CSS.json \
    $$PWD/inspector/protocol/Database.json \
    $$PWD/inspector/protocol/DOM.json \
    $$PWD/inspector/protocol/DOMDebugger.json \
    $$PWD/inspector/protocol/DOMStorage.json \
    $$PWD/inspector/protocol/HeapProfiler.json \
    $$PWD/inspector/protocol/IndexedDB.json \
    $$PWD/inspector/protocol/Input.json \
    $$PWD/inspector/protocol/LayerTree.json \
    $$PWD/inspector/protocol/Memory.json \
    $$PWD/inspector/protocol/Network.json \
    $$PWD/inspector/protocol/Page.json \
    $$PWD/inspector/protocol/Profiler.json \
    $$PWD/inspector/protocol/Timeline.json \
    $$PWD/inspector/protocol/Worker.json

INSPECTOR_WEB_JSON = $$WebCore_INSPECTOR_SCRIPTS_DIR/CodeGeneratorInspectorStrings.py 
...
COMMAND_LINE_API_MODULE_SOURCE = $$PWD/inspector/CommandLineAPIModuleSource.js
...
#
    ...
    $$PWD/crypto/CryptoKey.idl \
    $$PWD/crypto/CryptoKeyPair.idl \
    $$PWD/crypto/SubtleCrypto.idl \
    $$PWD/css/Counter.idl \
...
enable?(MEDIA_SOURCE) {
  IDL_BINDINGS += \
    $$PWD/Modules/mediasource/AudioTrackMediaSource.idl \
    $$PWD/Modules/mediasource/DOMURLMediaSource.idl \
    ...
    $$PWD/Modules/mediasource/TextTrackMediaSource.idl \
    $$PWD/Modules/mediasource/VideoPlaybackQuality.idl \
    $$PWD/Modules/mediasource/VideoTrackMediaSource.idl
}
...
enable?(MEDIA_STREAM) {
  IDL_BINDINGS += \
    ...
    $$PWD/Modules/mediastream/NavigatorMediaStream.idl \
...
enable?(FJIB_VIAPI) {
  IDL_BINDINGS += \
    $$PWD/Modules/vehicle/NavigatorVehicle.idl \
    $$PWD/Modules/vehicle/AvailableCallback.idl \
    $$PWD/Modules/vehicle/VehicleInterfaceCallback.idl \
    $$PWD/Modules/vehicle/VehicleInterface.idl \
	$$PWD/Modules/vehicle/ViApiHistory.idl \
	$$PWD/Modules/vehicle/ViApiHistoryItem.idl \
    $$PWD/Modules/vehicle/VehicleSignalInterface.idl \
    $$PWD/Modules/vehicle/VehicleConfigurationInterface.idl \
    $$PWD/Modules/vehicle/VehicleCommonDataType.idl \
    $$PWD/Modules/vehicle/VehicleInterfaceError.idl \
    $$PWD/Modules/vehicle/Vehicle.idl \
    $$PWD/Modules/vehicle/Zone.idl \
    $$PWD/Modules/vehicle/Identification.idl \
    $$PWD/Modules/vehicle/SizeConfiguration.idl \
    $$PWD/Modules/vehicle/FuelConfiguration.idl \
    $$PWD/Modules/vehicle/FuelOptions.idl \
    $$PWD/Modules/vehicle/TransmissionConfiguration.idl \
    $$PWD/Modules/vehicle/WheelConfiguration.idl \
    $$PWD/Modules/vehicle/SteeringWheelConfiguration.idl \
    $$PWD/Modules/vehicle/VehicleSpeed.idl \
    $$PWD/Modules/vehicle/WheelSpeed.idl \
    $$PWD/Modules/vehicle/EngineSpeed.idl \
    $$PWD/Modules/vehicle/VehiclePowerModeType.idl \
    $$PWD/Modules/vehicle/PowertrainTorque.idl \
    $$PWD/Modules/vehicle/AcceleratorPedalPosition.idl \
    $$PWD/Modules/vehicle/ThrottlePosition.idl \
    $$PWD/Modules/vehicle/Trip.idl \
    $$PWD/Modules/vehicle/TripMeters.idl \
    $$PWD/Modules/vehicle/Transmission.idl \
    $$PWD/Modules/vehicle/CruiseControlStatus.idl \
    $$PWD/Modules/vehicle/LightStatus.idl \
    $$PWD/Modules/vehicle/InteriorLightStatus.idl \
    $$PWD/Modules/vehicle/Horn.idl \
    $$PWD/Modules/vehicle/Chime.idl \
    $$PWD/Modules/vehicle/Fuel.idl \
    $$PWD/Modules/vehicle/EngineOil.idl \
    $$PWD/Modules/vehicle/Acceleration.idl \
    $$PWD/Modules/vehicle/EngineCoolant.idl \
    $$PWD/Modules/vehicle/SteeringWheel.idl \
    $$PWD/Modules/vehicle/IgnitionTime.idl \
    $$PWD/Modules/vehicle/Gyro.idl \
    $$PWD/Modules/vehicle/BrakeOperation.idl \
    $$PWD/Modules/vehicle/WheelTick.idl \
    $$PWD/Modules/vehicle/VehicleButton.idl \
    $$PWD/Modules/vehicle/ButtonEvent.idl \
    $$PWD/Modules/vehicle/DrivingStatus.idl \
    $$PWD/Modules/vehicle/NightMode.idl \
    $$PWD/Modules/vehicle/StartStopMode.idl \
    $$PWD/Modules/vehicle/Odometer.idl \
    $$PWD/Modules/vehicle/TransmissionOil.idl \
    $$PWD/Modules/vehicle/TransmissionClutch.idl \
    $$PWD/Modules/vehicle/BrakeMaintenance.idl \
    $$PWD/Modules/vehicle/MalfunctionIndicator.idl \
    $$PWD/Modules/vehicle/BatteryStatus.idl \
    $$PWD/Modules/vehicle/WasherFluid.idl \
    $$PWD/Modules/vehicle/Tire.idl \
    $$PWD/Modules/vehicle/TroubleCode.idl \
    $$PWD/Modules/vehicle/Diagnostic.idl \
    $$PWD/Modules/vehicle/LanguageConfiguration.idl \
    $$PWD/Modules/vehicle/UnitsOfMeasure.idl \
    $$PWD/Modules/vehicle/Mirror.idl \
    $$PWD/Modules/vehicle/DriveMode.idl \
    $$PWD/Modules/vehicle/SeatAdjustment.idl \
    $$PWD/Modules/vehicle/DashboardIllumination.idl \
    $$PWD/Modules/vehicle/VehicleSound.idl \
    $$PWD/Modules/vehicle/AntilockBrakingSystem.idl \
    $$PWD/Modules/vehicle/TractionControlSystem.idl \
    $$PWD/Modules/vehicle/ElectronicStabilityControl.idl \
    $$PWD/Modules/vehicle/TopSpeedLimit.idl \
    $$PWD/Modules/vehicle/AirbagStatus.idl \
    $$PWD/Modules/vehicle/Door.idl \
    $$PWD/Modules/vehicle/ChildSafetyLock.idl \
    $$PWD/Modules/vehicle/Seat.idl \
    $$PWD/Modules/vehicle/Temperature.idl \
    $$PWD/Modules/vehicle/RainSensor.idl \
    $$PWD/Modules/vehicle/WiperStatus.idl \
    $$PWD/Modules/vehicle/Defrost.idl \
    $$PWD/Modules/vehicle/Sunroof.idl \
    $$PWD/Modules/vehicle/ConvertibleRoof.idl \
    $$PWD/Modules/vehicle/SideWindow.idl \
    $$PWD/Modules/vehicle/ClimateControl.idl \
    $$PWD/Modules/vehicle/AtmosphericPressure.idl \
    $$PWD/Modules/vehicle/LaneDepartureDetection.idl \
    $$PWD/Modules/vehicle/Alarm.idl \
    $$PWD/Modules/vehicle/ParkingBrake.idl \
    $$PWD/Modules/vehicle/ParkingSensors.idl
}

enable?(FJIB_AMB) {
  IDL_BINDINGS += \
	$$PWD/Modules/fjibamb/AMBInterface.idl \
	$$PWD/Modules/fjibamb/AMBHistoryCallback.idl \
	$$PWD/Modules/fjibamb/AMBObject.idl \
	$$PWD/Modules/fjibamb/NavigatorFjIbAMB.idl \
	$$PWD/Modules/fjibamb/AMBErrorCallback.idl \
	$$PWD/Modules/fjibamb/AMBError.idl \
	$$PWD/Modules/fjibamb/AMBCallback.idl \
	$$PWD/Modules/fjibamb/AMBContext.idl
}

enable?(SCRIPTED_SPEECH) {
	IDL_BINDINGS += \
		$$PWD/Modules/speech/SpeechRecognitionResultList.idl \
		$$PWD/Modules/speech/SpeechGrammar.idl \
		$$PWD/Modules/speech/SpeechRecognition.idl \
		$$PWD/Modules/speech/SpeechRecognitionAlternative.idl \
		$$PWD/Modules/speech/SpeechGrammarList.idl \
		$$PWD/Modules/speech/SpeechRecognitionEvent.idl \
		$$PWD/Modules/speech/SpeechRecognitionError.idl \
		$$PWD/Modules/speech/SpeechRecognitionResult.idl
}

enable?(SPEECH_SYNTHESIS) {
	IDL_BINDINGS += \
		$$PWD/Modules/speech/SpeechSynthesisEvent.idl \
		$$PWD/Modules/speech/DOMWindowSpeechSynthesis.idl \
		$$PWD/Modules/speech/SpeechSynthesisVoice.idl \
		$$PWD/Modules/speech/SpeechSynthesisUtterance.idl \
		$$PWD/Modules/speech/SpeechSynthesis.idl
}

enable?(NETWORK_INFO) {
	IDL_BINDINGS += \
		$$PWD/Modules/networkinfo/NetworkInfoConnection.idl \
		$$PWD/Modules/networkinfo/NavigatorNetworkInfoConnection.idl
}

qtPrepareTool(QMAKE_MOC, moc)

use?(v8): wrapperFactoryArg = --wrapperFactoryV8 
...
mathmlnames.commands = perl -I$$PWD/bindings/scripts $$mathmlnames.script --tags $$PWD/mathml/mathtags.in --attrs $$PWD/mathml/mathattrs.in --extraDefines \"$${DEFINES} $$configDefines()\" --preprocessor \"$${QMAKE_MOC} -E\" --factory $$wrapperFactoryArg --outputDir ${QMAKE_FUNC_FILE_OUT_PATH}
...
svgnames.commands = perl -I$$PWD/bindings/scripts $$svgnames.script --tags $$PWD/svg/svgtags.in --attrs $$PWD/svg/svgattrs.in --extraDefines \"$${DEFINES} $$configDefines()\" --preprocessor \"$${QMAKE_MOC} -E\" --factory $$wrapperFactoryArg --outputDir ${QMAKE_FUNC_FILE_OUT_PATH}
...
#
    equals(QT_MAJOR_VERSION, 5): preprocessIdls.commands += "echo $$binding>> $$IDL_FILES_TMP$$EOC"
    equals(QT_MAJOR_VERSION, 4): preprocessIdls.commands += "; echo $$binding>> $$IDL_FILES_TMP$$EOC"
}
...
use?(v8) { 
	...
	generateBindings.commands = $$setEnvironmentVariable(SOURCE_ROOT, $$toSystemPath($$PWD)) && perl -I$$PWD/bindings/scripts $$generateBindings.script \
                            --defines \"$$javascriptFeatureDefines()\" \
                            --generator $$generator \
                            --idlIncludeFile $$PWD/bindings/scripts/IDLInclude.txt \
                            --outputDir ${QMAKE_FUNC_FILE_OUT_PATH} \
                            --supplementalDependencyFile ${QMAKE_FUNC_FILE_OUT_PATH}/$$SUPPLEMENTAL_DEPENDENCY_FILE \
                            --idlAttributesFile $${IDL_ATTRIBUTES_FILE} \
                            --preprocessor \"$${QMAKE_MOC} -E\" ${QMAKE_FILE_NAME}
...
#inspectorUIlocalizedStrings.output = localizedStrings.js
#inspectorUIlocalizedStrings.input = INSPECTORUI_LOCALIZEDSTRINGS_SOURCE_DIR
#inspectorUIlocalizedStrings.commands = $$QMAKE_MKDIR $$toSystemPath($$INSPECTORUI_LOCALIZEDSTRINGS_TARGET_DIR) && $$QMAKE_COPY $$toSystemPath($$INSPECTORUI_LOCALIZEDSTRINGS_SOURCE_DIR) $$toSystemPath($$INSPECTORUI_LOCALIZEDSTRINGS_TARGET_DIR)
#inspectorUIlocalizedStrings.add_output_to_sources = false
#GENERATORS += inspectorUIlocalizedStrings

# Generate InspectorWeb.json
InspectorWeb.output = InspectorWeb.json
InspectorWeb.input =  INSPECTOR_WEB_DOMAINS
InspectorWeb.script = $$WebCore_INSPECTOR_SCRIPTS_DIR/generate-combined-inspector-json.py
InspectorWeb.commands = python $$WebCore_INSPECTOR_SCRIPTS_DIR/generate-combined-inspector-json.py $$PWD/inspector/protocol > ${QMAKE_FILE_OUT}
InspectorWeb.depends = $$INSPECTOR_WEB_DOMAINS $$WebCore_INSPECTOR_SCRIPTS_DIR/generate-combined-inspector-json.py
InspectorWeb.add_output_to_sources = false
InspectorWeb.CONFIG = combine
GENERATORS += InspectorWeb 

!use?(v8) {
# All Web Inspector generated files are created with this one call to CodeGeneratorInspector.pm
inspectorWebJSON.output = InspectorWebBackendDispatchers.cpp InspectorWebBackendDispatchers.h InspectorWebFrontendDispatchers.cpp InspectorWebFrontendDispatchers.h InspectorWebTypeBuilders.cpp InspectorWebTypeBuilders.h
inspectorWebJSON.input = INSPECTOR_WEB_JSON
inspectorWebJSON.script = $$WebCore_INSPECTOR_SCRIPTS_DIR/CodeGeneratorInspector.py
inspectorWebJSON.commands = python $$WebCore_INSPECTOR_SCRIPTS_DIR/CodeGeneratorInspector.py ${QMAKE_FUNC_FILE_OUT_PATH}/InspectorWeb.json  $${JAVASCRIPTCORE_GENERATED_SOURCES_DIR}/InspectorJS.json --output_h_dir ${QMAKE_FUNC_FILE_OUT_PATH} --output_cpp_dir ${QMAKE_FUNC_FILE_OUT_PATH} --output_js_dir ${QMAKE_FUNC_FILE_OUT_PATH} --output_type Web --write_always
inspectorWebJSON.depends = $$WebCore_INSPECTOR_SCRIPTS_DIR/CodeGeneratorInspector.py $$WebCore_INSPECTOR_SCRIPTS_DIR/CodeGeneratorInspectorStrings.py ${QMAKE_FUNC_FILE_OUT_PATH}/InspectorWeb.json $${JAVASCRIPTCORE_GENERATED_SOURCES_DIR}/InspectorJS.json $${JAVASCRIPTCORE_GENERATED_SOURCES_DIR}/InspectorJSTypeBuilders.h
...
inspectorOverlayPage.commands = python $$WebCore_INSPECTOR_SCRIPTS_DIR/inline-and-minify-stylesheets-and-scripts.py $$PWD/inspector/InspectorOverlayPage.html ${QMAKE_FUNC_FILE_OUT_PATH}/InspectorOverlayPage.combined.html && perl $$WebCore_INSPECTOR_SCRIPTS_DIR/xxd.pl InspectorOverlayPage_html ${QMAKE_FUNC_FILE_OUT_PATH}/InspectorOverlayPage.combined.html ${QMAKE_FILE_OUT}
inspectorOverlayPage.depends = $$INSPECTOR_OVERLAY_PAGE $$WebCore_INSPECTOR_SCRIPTS_DIR/inline-and-minify-stylesheets-and-scripts.py
inspectorOverlayPage.add_output_to_sources = false
inspectorOverlayPage.CONFIG = combine
GENERATORS += inspectorOverlayPage

# Generate CommandLineAPIModuleSource.h
CommandLineAPIModuleSource.output = CommandLineAPIModuleSource.h
CommandLineAPIModuleSource.input = COMMAND_LINE_API_MODULE_SOURCE
CommandLineAPIModuleSource.commands = python $$WebCore_INSPECTOR_SCRIPTS_DIR/jsmin.py <${QMAKE_FILE_IN} > ${QMAKE_FUNC_FILE_OUT_PATH}/CommandLineAPIModuleSource.min.js && perl $$WebCore_INSPECTOR_SCRIPTS_DIR/xxd.pl CommandLineAPIModuleSource_js ${QMAKE_FUNC_FILE_OUT_PATH}/CommandLineAPIModuleSource.min.js ${QMAKE_FILE_OUT}
CommandLineAPIModuleSource.add_output_to_sources = false
GENERATORS += CommandLineAPIModuleSource
...
InjectedScriptCanvasModuleSource.commands = python $$WebCore_INSPECTOR_SCRIPTS_DIR/jsmin.py <${QMAKE_FILE_IN} > ${QMAKE_FUNC_FILE_OUT_PATH}/InjectedScriptCanvasModuleSource.min.js && perl $$WebCore_INSPECTOR_SCRIPTS_DIR/xxd.pl InjectedScriptCanvasModuleSource_js ${QMAKE_FUNC_FILE_OUT_PATH}/InjectedScriptCanvasModuleSource.min.js ${QMAKE_FILE_OUT}
...
htmlnames.commands = perl -I$$PWD/bindings/scripts $$htmlnames.script --tags $$PWD/html/HTMLTagNames.in --attrs $$PWD/html/HTMLAttributeNames.in --extraDefines \"$${DEFINES} $$configDefines()\" --preprocessor \"$${QMAKE_MOC} -E\"  --factory $$wrapperFactoryArg --outputDir ${QMAKE_FUNC_FILE_OUT_PATH}
...
enable?(XSLT) {
    ...
    xmlviewercss.script = $$WebCore_INSPECTOR_SCRIPTS_DIR/xxd.pl
    xmlviewercss.commands = python $$WebCore_INSPECTOR_SCRIPTS_DIR/cssmin.py <$$XMLVIEWER_CSS > ${QMAKE_FUNC_FILE_OUT_PATH}/XMLViewer.min.css && perl $$xmlviewercss.script XMLViewer_css ${QMAKE_FUNC_FILE_OUT_PATH}/XMLViewer.min.css ${QMAKE_FILE_OUT}
    xmlviewercss.clean = ${QMAKE_FILE_OUT} ${QMAKE_FUNC_FILE_OUT_PATH}/XMLViewer.min.css
    xmlviewercss.depends = $$WebCore_INSPECTOR_SCRIPTS_DIR/xxd.pl $$WebCore_INSPECTOR_SCRIPTS_DIR/cssmin.py
    ...
    xmlviewerjs.script = $$WebCore_INSPECTOR_SCRIPTS_DIR/xxd.pl
    xmlviewerjs.commands = python $$WebCore_INSPECTOR_SCRIPTS_DIR/jsmin.py <$$XMLVIEWER_JS > ${QMAKE_FUNC_FILE_OUT_PATH}/XMLViewer.min.js && perl $$xmlviewerjs.script XMLViewer_js ${QMAKE_FUNC_FILE_OUT_PATH}/XMLViewer.min.js ${QMAKE_FILE_OUT}
    xmlviewerjs.clean = ${QMAKE_FILE_OUT} ${QMAKE_FUNC_FILE_OUT_PATH}/XMLViewer.min.js
    xmlviewerjs.depends = $$WebCore_INSPECTOR_SCRIPTS_DIR/xxd.pl $$WebCore_INSPECTOR_SCRIPTS_DIR/jsmin.py
...
v8arrayBufferViewCustomScript.script = $$WebCore_INSPECTOR_SCRIPTS_DIR/xxd.pl
v8arrayBufferViewCustomScript.output = V8ArrayBufferViewCustomScript.h
v8arrayBufferViewCustomScriptn.input = v8arrayBufferViewCustomScript.script
v8arrayBufferViewCustomScript.commands = perl $$v8arrayBufferViewCustomScript.script V8ArrayBufferViewCustomScript_js $$PWD/bindings/v8/custom/V8ArrayBufferViewCustomScript.js generated/V8ArrayBufferViewCustomScript.h
v8arrayBufferViewCustomScript.clean = ${QMAKE_FUNC_FILE_OUT_PATH}/V8ArrayBufferViewCustomScript.h
v8arrayBufferViewCustomScript.add_output_to_sources = false
GENERATORS += v8arrayBufferViewCustomScript
