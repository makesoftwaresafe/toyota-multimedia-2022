...
public:
    ...
    static WEBCORE_API PassRefPtr<DOMWrapperWorld> createWorld();

    JSDOMWindowShell* createWindowShell(DOMWrapperWorld&);
    void destroyWindowShell(DOMWrapperWorld&);

    WEBCORE_API JSDOMWindowShell* windowShell(DOMWrapperWorld& world)
    {
    ...
    WEBCORE_API Deprecated::ScriptValue executeScript(const ScriptSourceCode&);
    Deprecated::ScriptValue executeScript(const String& script, bool forceUserGesture = false);
/**/
	Deprecated::ScriptValue executeScript(const ScriptSourceCode&, WebCore::Element*);
/**/
    ...
    static WEBCORE_API void initializeThreading();

    Deprecated::ScriptValue evaluate(const ScriptSourceCode&);
/**/
	Deprecated::ScriptValue evaluate(const ScriptSourceCode&, WebCore::Element*);
/**/
    ...
    static WEBCORE_API bool processingUserGesture();
    ...
    WEBCORE_API JSC::Bindings::RootObject* bindingRootObject();
    WEBCORE_API JSC::Bindings::RootObject* cacheableBindingRootObject();
...
private:
    WEBCORE_API JSDOMWindowShell* initScript(DOMWrapperWorld&);
