...
equals(QT_MAJOR_VERSION, 5): QT *= core-private gui-private
equals(QT_MAJOR_VERSION, 4): QT *= core gui
#
...
INCLUDEPATH += \
    ...
    $$SOURCE_DIR/platform/mock/mediasource \
...
use?(v8) {
    INCLUDEPATH += \
        ...
        $${ROOT_WEBKIT_DIR}/Source/JavaScriptCore/jit \
        $${ROOT_WEBKIT_DIR}/Source/JavaScriptCore/assembler \
        $${ROOT_WEBKIT_DIR}/Source/JavaScriptCore/disassembler \
        $${ROOT_WEBKIT_DIR}/Source/JavaScriptCore/llint \
        $${ROOT_WEBKIT_DIR}/Source/JavaScriptCore/bytecode \
        $${ROOT_WEBKIT_DIR}/Source/JavaScriptCore/heap \
        $${ROOT_WEBKIT_DIR}/Source/JavaScriptCore/profiler \
} else {
INCLUDEPATH += \
...
enable?(INDEXED_DATABASE) {
	DEFINES += WTF_USE_LEVELDB=1
	INCLUDEPATH += \
		$$SOURCE_DIR/../ThirdParty/leveldb \
		$$SOURCE_DIR/../ThirdParty/leveldb/include \
		$$SOURCE_DIR/Modules/indexeddb/leveldb
	LIBS += -lleveldb
}
#151224 modify end
...
enable?(MEDIA_STREAM) {
LIBS += -L$$(WEBRTC_LIBRARY_DIR) -lfjib_webrtc -lusrsctp -lsrtp -lvpx -lyuv -lopus
}
...
#use?(webp): LIBS += -lwebp
#contains(DEFINES, WTF_USE_WEBP=1): LIBS += -lwebp
...
#
LIBS += -L$$SOURCE_DIR/../../webkit-thirdparty/InspiriumExtension -lInspiriumExtension
#
...
# uncomment here when pdfium uses v8
# DEFINES += PDF_ENABLE_V8
# LIBS += \
#	${PDFIUM_LIBS_ROOT}/v8/tools/gyp/libv8_libplatform.a \
#	${PDFIUM_LIBS_ROOT}/v8/tools/gyp/libv8_base.a \
#	${PDFIUM_LIBS_ROOT}/v8/tools/gyp/libv8_snapshot.a \
#	${PDFIUM_LIBS_ROOT}/v8/tools/gyp/libv8_libbase.a
