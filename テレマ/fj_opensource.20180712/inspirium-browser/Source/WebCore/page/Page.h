...
public:
    ...
    explicit WEBCORE_API Page(PageClients&);
    WEBCORE_API ~Page();
    ...
    WEBCORE_API ViewportArguments viewportArguments() const;

    static void refreshPlugins(bool reload);
    WEBCORE_API PluginData& pluginData() const;
    ...
    WEBCORE_API void goToItem(HistoryItem*, FrameLoadType);

    WEBCORE_API void setGroupName(const String&);
    ...
    static WEBCORE_API ViewMode stringToViewMode(const String&);

    ViewMode viewMode() const { return m_viewMode; }
    WEBCORE_API void setViewMode(ViewMode);
#endif // ENABLE(VIEW_MODE_CSS_MEDIA)

    void setTabKeyCyclesThroughElements(bool b) { m_tabKeyCyclesThroughElements = b; }
    bool tabKeyCyclesThroughElements() const { return m_tabKeyCyclesThroughElements; }

    WEBCORE_API bool findString(const String&, FindOptions);

    PassRefPtr<Range> rangeOfString(const String&, Range*, FindOptions);

    unsigned countFindMatches(const String&, FindOptions, unsigned maxMatchCount);
    WEBCORE_API unsigned markAllMatchesForText(const String&, FindOptions, bool shouldHighlight, unsigned maxMatchCount);

    WEBCORE_API void unmarkAllTextMatches();
    ...
    WEBCORE_API void setDeviceScaleFactor(float);
    ...
    WEBCORE_API void setIsVisible(bool);
    void setIsPrerender();
    ...
    WEBCORE_API void setCustomHTMLTokenizerTimeDelay(double);
#if PLATFORM(IOS)
    ...
    WEBCORE_API void setCustomHTMLTokenizerChunkSize(int);
    ...
    WEBCORE_API PageVisibilityState visibilityState() const;
#endif
    void resumeAnimatingImages();

    WEBCORE_API void addLayoutMilestones(LayoutMilestones);
...
/**/
    void dispatchError(const ResourceError& error);
/**/
#ifndef NDEBUG
