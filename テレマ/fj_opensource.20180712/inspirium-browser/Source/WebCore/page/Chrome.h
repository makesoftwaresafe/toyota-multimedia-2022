...
public:
    ...
    WEBCORE_API Page* createWindow(Frame*, const FrameLoadRequest&, const WindowFeatures&, const NavigationAction&) const;
    WEBCORE_API void show() const;
...
#if ENABLE(FJIB_PDF)
    //pdf API
    void showPDFErrorAlert(Frame*, int errorcode, const String&);
    bool requirePDFPasswordPrompt(Frame*, const String& message, const String& defaultValue, String& result);
#endif
