...
public:
    ...
    virtual WEBCORE_API void invalidateRect(const IntRect&) override;
    ...
    WEBCORE_API void updateCanHaveScrollbars();
    ...
    WEBCORE_API void layout(bool allowSubtree = true);
    bool didFirstLayout() const;
    void layoutTimerFired(Timer<FrameView>&);
    void scheduleRelayout();
    void scheduleRelayoutOfSubtree(RenderElement&);
    void unscheduleRelayout();
    WEBCORE_API bool layoutPending() const;
    ...
    WEBCORE_API bool needsLayout() const;
    void setNeedsLayout();
...
#if ENABLE(REQUEST_ANIMATION_FRAME)
    WEBCORE_API void serviceScriptedAnimations(double monotonicAnimationStartTime);
#endif
    ...
    WEBCORE_API bool flushCompositingStateIncludingSubframes();
    ...
    WEBCORE_API void updateBackgroundRecursively(const Color&, bool);
    ...
    WEBCORE_API void adjustViewSize();
    
    virtual WEBCORE_API IntRect windowClipRect(bool clipToContents = true) const override;
    ...
    virtual WEBCORE_API void setFixedVisibleContentRect(const IntRect&) override;
#endif
    ...
    virtual WEBCORE_API void paintContents(GraphicsContext*, const IntRect& damageRect) override;
    void setPaintBehavior(PaintBehavior);
    PaintBehavior paintBehavior() const;
    bool isPainting() const;
    bool hasEverPainted() const { return m_lastPaintTime; }
    void setLastPaintTime(double lastPaintTime) { m_lastPaintTime = lastPaintTime; }
    WEBCORE_API void setNodeToDraw(Node*);
    ...
    WEBCORE_API void updateLayoutAndStyleIfNeededRecursive();
    ...
    WEBCORE_API bool scrollToAnchor(const String&);
