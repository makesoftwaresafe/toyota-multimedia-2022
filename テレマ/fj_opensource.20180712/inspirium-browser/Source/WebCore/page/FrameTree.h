...
namespace WebCore {
    ...
    public:
        ...
        WEBCORE_API void setName(const AtomicString&);
        void clearName();
        WEBCORE_API Frame* parent() const;
        ...
        WEBCORE_API Frame* traverseNext(const Frame* stayWithin = 0) const;
        WEBCORE_API Frame* traverseNextWithWrap(bool) const;
        Frame* traversePreviousWithWrap(bool) const;
        
        WEBCORE_API void appendChild(PassRefPtr<Frame>);
