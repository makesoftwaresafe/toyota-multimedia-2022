...
namespace WebCore {
    ...
    public:
        static WEBCORE_API PassRefPtr<Frame> create(Page*, HTMLFrameOwnerElement*, FrameLoaderClient*);

        WEBCORE_API void init();
#if PLATFORM(IOS)
        ...
        WEBCORE_API void createView(const IntSize&, const Color&, bool,
        ...
        WEBCORE_API RenderView* contentRenderer() const; // Root of the render tree for the document contained in this frame.
    ...
    // ======== All public functions below this point are candidates to move out of Frame into another class. ========
        ...
        WEBCORE_API void setPageZoomFactor(float factor);
        float pageZoomFactor() const { return m_pageZoomFactor; }
        WEBCORE_API void setTextZoomFactor(float factor);
        float textZoomFactor() const { return m_textZoomFactor; }
        WEBCORE_API void setPageAndTextZoomFactors(float pageZoomFactor, float textZoomFactor);
