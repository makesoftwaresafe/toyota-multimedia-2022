...
#else
        if (!overloads && m.signature() == signature)
#endif
/**/
...
#else
        setException(context, exception, QString(QLatin1String("cannot call function of deleted runtime method")));
#endif
/**/
        return JSValueMakeUndefined(context);
    }
...
#else
        setException(context, exception, QString(QLatin1String("cannot call function of deleted QObject")));
#endif
/**/
        return JSValueMakeUndefined(context);
    }
...
#else
        QString errorStr = QString(QLatin1String("QtMetaMethod.%1: Cannot connect to/from deleted QObject")).arg(connect ?  QString(QLatin1String("connect")) : QString(QLatin1String("disconnect")));
#endif
/**/
...
#else
    QString functionName = connect ? QString(QLatin1String("connect")) : QString(QLatin1String("disconnect"));
#endif
/**/
...
#else
        QString errorStr = QString(QLatin1String("QtMetaMethod.%1: no arguments given")).arg(connect ?  QString(QLatin1String("connect")) : QString(QLatin1String("disconnect")));
#endif
/**/
        setException(context, exception, errorStr);
        return JSValueMakeUndefined(context);
...
#else
        setException(context, exception, QString(QLatin1String("QtMetaMethod.%3: %1::%2() is not a signal")).arg(QString::fromUtf8(d->m_object.data()->metaObject()->className())).arg(QString::fromLatin1(d->m_identifier)).arg(functionName));
#endif
/**/
        return JSValueMakeUndefined(context);
    }
...
#else
            setException(context, exception, QString(QLatin1String("QtMetaMethod.%1: target is not a function")).arg(functionName));
#endif
/**/
            return JSValueMakeUndefined(context);
        }
...
#else
        QString message = QString(QLatin1String("QtMetaMethod.%1: target is not a function"));
#endif
/**/
        if (connect)
/**/ 
...
#else
            message = message.arg(QString(QLatin1String("connect")));
#endif
/**/
        else
/**/ 
...
#else
            message = message.arg(QString(QLatin1String("disconnect")));
#endif
/**/
        setException(context, exception, message);
        return JSValueMakeUndefined(context);
