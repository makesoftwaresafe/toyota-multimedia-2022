...
/**/
    ...
    static PassRefPtr<StyleCachedImage> create(CachedImage* image,Page* page) { return adoptRef(new StyleCachedImage(image,page)); }
/**/
    virtual ~StyleCachedImage();

    virtual CachedImage* cachedImage() const override { return m_image.get(); }
/**/    
    virtual Page* getErrorNotifyPage();
/**/
...
/**/   
    explicit StyleCachedImage(CachedImage*,Page*);
/**/   
