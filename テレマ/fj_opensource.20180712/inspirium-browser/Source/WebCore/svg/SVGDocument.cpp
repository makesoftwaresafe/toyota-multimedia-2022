...
/**/
void SVGDocument::addElementById(const AtomicStringImpl& elementId, Element& element)
{
    Document::addElementById(elementId, element);
    AtomicStringImpl* idStrImpl = (AtomicStringImpl*)&elementId;
    AtomicString id = AtomicString(idStrImpl);
    accessSVGExtensions()->buildPendingResourcesIfNeeded(id);
}
/**/
