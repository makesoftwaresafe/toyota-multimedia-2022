...
bool RenderThemeQt::paintSearchFieldDecorationPart(RenderObject* o, const PaintInfo& pi,
                                               const IntRect& r)
{
    notImplemented();
...
bool RenderThemeQt::paintSearchFieldResultsDecorationPart(RenderObject* o, const PaintInfo& pi,
                                                      const IntRect& r)
{
    notImplemented();
...
bool RenderThemeQt::paintMediaSliderThumb(RenderObject* o, const PaintInfo& paintInfo, const IntRect& r)
{
    ...
    if (!hostNode)
        hostNode = o->node();
    HTMLMediaElement* mediaElement = parentMediaElement(hostNode);
    if (!mediaElement)
        return false;
