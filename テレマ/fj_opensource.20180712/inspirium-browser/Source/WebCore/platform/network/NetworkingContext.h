...
/**/
#if PLATFORM(WIN)
#include "CeNetworkAccessManager.h"
#endif
/**/

#if PLATFORM(INSPIRIUM)
#include "InspNetworkAccessManager.h"
#endif
...
public:
    ...
    virtual ResourceError blockedError(const ResourceRequest&) const = 0;
/**/
	virtual CeNetworkAccessManager* networkAccessManager() const = 0;
/**/
    ...
    virtual String referrer() const = 0;
    virtual ResourceError blockedError(const ResourceRequest&) const = 0;
	virtual InspNetworkAccessManager* networkAccessManager() const = 0;
#endif
