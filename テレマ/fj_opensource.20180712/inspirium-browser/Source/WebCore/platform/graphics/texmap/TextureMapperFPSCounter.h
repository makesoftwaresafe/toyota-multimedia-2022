...
#if !OS(WINCE) && USE(TEXTURE_MAPPER)
...
public:
    WEBCORE_API TextureMapperFPSCounter();
    WEBCORE_API void updateFPSAndDisplay(TextureMapper*, const FloatPoint& = FloatPoint::zero(), const TransformationMatrix& = TransformationMatrix());
