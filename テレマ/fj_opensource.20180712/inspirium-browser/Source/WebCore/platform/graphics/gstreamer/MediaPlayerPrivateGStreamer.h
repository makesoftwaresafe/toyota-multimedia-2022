...
//--
    ...
    enum GST_PermissionType {
        Allow,
        Disallow,
        PermissionNum
    };

    static bool  fjib_set_gstplayer_permission(GST_MediaType,GST_PermissionType);
    static bool  fjib_set_gstplayer(void* p, GST_MediaType no);
    static void* fjib_get_gstplayer(GST_MediaType no);
    bool removeAudio();
    bool removeVideo();
//--
