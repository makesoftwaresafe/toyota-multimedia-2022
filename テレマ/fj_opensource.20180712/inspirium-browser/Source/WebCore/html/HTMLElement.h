...
public:
    ...
    WEBCORE_API String innerHTML() const;
    WEBCORE_API String outerHTML() const;
    WEBCORE_API void setInnerHTML(const String&, ExceptionCode&);
    WEBCORE_API void setOuterHTML(const String&, ExceptionCode&);
    WEBCORE_API void setInnerText(const String&, ExceptionCode&);
    ...
    WEBCORE_API bool ieForbidsInsertHTML() const;
