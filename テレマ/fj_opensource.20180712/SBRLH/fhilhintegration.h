...
#ifndef FHILHINTEGRATION_H
#define FHILHINTEGRATION_H

#include <qpa/qplatformintegration.h>

QT_BEGIN_NAMESPACE

class FhiLhIntegration : public QPlatformIntegration
{
public:
    ...
    explicit FhiLhIntegration(const QStringList &parameters);
    ~FhiLhIntegration();
