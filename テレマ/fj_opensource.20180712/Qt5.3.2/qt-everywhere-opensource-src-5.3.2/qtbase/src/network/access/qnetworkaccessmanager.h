...
public:
	...
	void showOutputHeaderRequestResponseLog(QNetworkReply *reply); // not called
	...
	static void setTimeOut(unsigned long second);
    static unsigned long timeOut();

    static void setSynchronousTimeout(unsigned long second);
