...
{
public:
	QNetworkCookieJarPrivate();
    void load();
    void save();
    void save(const QNetworkCookie& cookie);
    void purgeOldCookies();
    QString fileName(const QNetworkCookie& cookie);
    void remove();
    void remove(const QNetworkCookie& cookie);
#if 0
    qint64 size();
#endif

    QList<QNetworkCookie> allCookies;
    qint64 cookieCapacity;
    qint64 cookieSavedSize;
    QString cookiePath;
