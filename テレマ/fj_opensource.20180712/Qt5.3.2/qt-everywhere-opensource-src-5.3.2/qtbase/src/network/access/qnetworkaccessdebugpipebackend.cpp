...
void QNetworkAccessDebugPipeBackend::closeDownstreamChannel()
{
    ...
    DEBUG_SOCKET_QDEBUG("QNetworkAccessDebugPipeBackend::closeDownstreamChannel() %d",operation());
#endif
...
{
#ifdef FJ_INSP_NETWORKLOG2
    DEBUG_SOCKET_QDEBUG("QNetworkAccessDebugPipeBackend::socketError() %d",socket.error());
#endif
