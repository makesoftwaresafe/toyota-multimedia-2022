...
#ifdef FJ_INSP_NETWORKLOG2
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::setServerName() called while not in unconnected state");
#endif
        return;
    }
    d->serverName = name;
...
QDebug operator<<(QDebug debug, QLocalSocket::LocalSocketError error)
{
    ...
    case QLocalSocket::ConnectionRefusedError:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::ConnectionRefusedError");
        break;
    case QLocalSocket::PeerClosedError:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::PeerClosedError");
        break;
    case QLocalSocket::ServerNotFoundError:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::ServerNotFoundError");
        break;
    case QLocalSocket::SocketAccessError:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::SocketAccessError");
        break;
    case QLocalSocket::SocketResourceError:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::SocketResourceError");
        break;
    case QLocalSocket::SocketTimeoutError:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::SocketTimeoutError");
        break;
    case QLocalSocket::DatagramTooLargeError:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::DatagramTooLargeError");
        break;
    case QLocalSocket::ConnectionError:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::ConnectionError");
        break;
    case QLocalSocket::UnsupportedSocketOperationError:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::UnsupportedSocketOperationError");
        break;
    case QLocalSocket::UnknownSocketError:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::UnknownSocketError");
        break;
    default:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::SocketError(%d)", int(error));
        break;
    }
#endif
    return debug;
...
QDebug operator<<(QDebug debug, QLocalSocket::LocalSocketState state)
{
    ...
    case QLocalSocket::UnconnectedState:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::UnconnectedState");
        break;
    case QLocalSocket::ConnectingState:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::ConnectingState");
        break;
    case QLocalSocket::ConnectedState:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::ConnectedState");
        break;
    case QLocalSocket::ClosingState:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::ClosingState");
        break;
    default:
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::SocketState(%d)", int(state));
        break;
    }
#endif
    return debug;
