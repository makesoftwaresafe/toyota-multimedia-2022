...
{
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::resetSocketLayer():socketp=%x, socketEngine=0",this);
#endif
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::initSocketLayer: socketp=%x, socketEngine=%x", this, socketEngine);
#endif
    if (!socketEngine) {
...
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::initSocketLayer(%s, %s) failed (%s):socketp=%x", typeStr.toLatin1().constData(), protocolStr.toLatin1().constData(), socketEngine->errorString().toLatin1().constData(),this);
#endif
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::initSocketLayer(%s, %s) success:socketp=%x", typeStr.toLatin1().constData(), protocolStr.toLatin1().constData(),this);
#endif
    return true;
}
...
bool QAbstractSocketPrivate::canReadNotification()
{
    Q_Q(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::canReadNotification():socketp=%x",this);
#endif
    ...
    if (isBuffered) {
...
#ifdef FJ_INSP_NETWORKLOG
            DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::canReadNotification() buffer is full:socketp=%x:socketp=%x",this);
#endif
            return false;
        }
        ...
        if (!readFromSocket()) {
#ifdef FJ_INSP_NETWORKLOG
            DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::canReadNotification() disconnecting socket:socketp=%x",this);
#endif
...
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::canReadNotification() socket is closing - returning:socketp=%x",this);
#endif
        return true;
    }
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG2("QAbstractSocketPrivate::canCloseNotification()");
#endif
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::canWriteNotification() flushing:socketp=%x",this);
#endif
...
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::connectionNotification() testing connection:socketp=%x",this);
#endif
        _q_testConnection();
    }
}
...
#ifdef FJ_INSP_NETWORKLOG
    	DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::flush() nothing to do: valid ? %s, writeBuffer.isEmpty() ? %s:socketp=%x",
           socketEngine->isValid() ? "yes" : "no", writeBuffer.isEmpty() ? "yes" : "no",this);
#endif
...
#ifdef FJ_INSP_NETWORKLOG
#if 0
	if(getenv("INSPIRIUM_DEBUG_SOCKET"))
        qDebug() << "QAbstractSocketPrivate::flush() write error, aborting." << socketEngine->errorString();
#else
		DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::flush() write error, aborting, %s:socketp=%x", socketEngine->errorString().toUtf8().constData(),this);
#endif
#endif
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::flush() %lld bytes written to the network:socketp=%x",
    	written,this);
#endif
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::startConnectingByName(host == %s) :socketp=%x", qPrintable(host),this);
#endif
...
void QAbstractSocketPrivate::_q_startConnecting(const QHostInfo &hostInfo)
{
...
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG2("QAbstractSocketPrivate::_q_startConnecting() received hostInfo for wrong lookup ID %d expected %d", hostInfo.lookupId(), hostLookupId);
#endif
    }
    ...
    s += QLatin1Char('}');
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::_q_startConnecting(hostInfo == %s) :socketp=%x", s.toLatin1().constData(),this);
#endif
...
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::_q_startConnecting(), host not found :socketp=%x",this);
#endif
        state = QAbstractSocket::UnconnectedState;
...
void QAbstractSocketPrivate::_q_connectToNextAddress()
{
    ...
    do {
        ...
        if (addresses.isEmpty()) {
#ifdef FJ_INSP_NETWORKLOG
            DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::_q_connectToNextAddress(), all addresses failed. :socketp=%x",this);
#endif
            state = QAbstractSocket::UnconnectedState;
            if (socketEngine) {
...
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::_q_connectToNextAddress(), connecting to %s:%i, %d left to try :socketp=%x",
        	host.toString().toLatin1().constData(), port, addresses.count(),this);
#endif
...
#ifdef FJ_INSP_NETWORKLOG
            DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::_q_connectToNextAddress(), skipping IPv6 entry :socketp=%x",this);
#endif
            continue;
        }
#endif
...
#ifdef FJ_INSP_NETWORKLOG
            DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::_q_connectToNextAddress(), failed to initialize sock layer :socketp=%x",this);
#endif
            continue;
        }
...
#ifdef FJ_INSP_NETWORKLOG
            DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::_q_connectToNextAddress(), connection failed (%s) :socketp=%x",
            	socketEngine->errorString().toLatin1().constData(),this);
#endif
            continue;
        }
...
void QAbstractSocketPrivate::_q_testConnection()
{
    if (socketEngine) {
        ...
        if (socketEngine->state() == QAbstractSocket::ConnectedState) {
            ...
            if (pendingClose) {
#ifdef FJ_INSP_NETWORKLOG
    			DEBUG_SOCKET_QDEBUG(" QAbstractSocketPrivate::_q_testConnection():pending close :socketp=%x",this);
#endif
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::_q_testConnection() connection failed,"
    	" checking for alternative addresses :socketp=%x",this);
#endif
    _q_connectToNextAddress();
}
...
void QAbstractSocketPrivate::_q_abortConnectionAttempt()
{
    Q_Q(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::_q_abortConnectionAttempt() (timed out) :socketp=%x",this);
#endif
    if (socketEngine)
        socketEngine->setWriteNotificationEnabled(false);
...
bool QAbstractSocketPrivate::readFromSocket()
{
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::readFromSocket() about to read %d bytes :socketp=%x",
    	int(bytesToRead),this);
#endif
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::readFromSocket() got %d bytes, buffer size = %d :socketp=%x",
           int(readBytes), buffer.size(),this);
#endif
    ...
    if (!socketEngine->isValid()) {
        ...
        emit q->error(socketError);
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::readFromSocket() read failed: %s :socketp=%x",
               q->errorString().toLatin1().constData(),this);
#endif
        resetSocketLayer();
        return false;
    }
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocketPrivate::fetchConnectionParameters() connection to %s:%i established :socketp=%x",
    	host.toString().toLatin1().constData(), port,this);
#endif
}
    ...
    : QIODevice(dd, parent)
{
    Q_D(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::QAbstractSocket(%sSocket, QAbstractSocketPrivate == %p, parent == %p) :socketp=%x",
    	socketType == TcpSocket ? "Tcp" : socketType == UdpSocket ? "Udp" : "Unknown", &dd, parent,this);
#endif
    ...
    : QIODevice(*new QAbstractSocketPrivate, parent)
{
    Q_D(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::QAbstractSocket(%p) :socketp=%x", parent,this);
#endif
    d->socketType = socketType;
}
...
QAbstractSocket::~QAbstractSocket()
{
    Q_D(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::~QAbstractSocket() :socketp=%x",this);
#endif
                                    ...
                                    NetworkLayerProtocol protocol)
{
    Q_D(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::connectToHost(\"%s\", %i, %i)... :socketp=%x", qPrintable(hostName), port, (int) openMode,d_func());
#endif

    if (d->state == ConnectedState || d->state == ConnectingState
        || d->state == ClosingState || d->state == HostLookupState) {
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::connectToHost() called when already looking up or connecting/connected to \"%s\"", qPrintable(hostName));
#endif
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::connectToHost(\"%s\", %i) == %s%s :socketp=%x", hostName.toLatin1().constData(), port,
    	(d->state == ConnectedState) ? "true" : "false",
    	(d->state == ConnectingState || d->state == HostLookupState)
    	? " (connection in progress)" : "",d_func());
#endif
}
...
{
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::connectToHost([%s], %i, %i)... :socketp=%x",
    	address.toString().toLatin1().constData(), port, (int) openMode,d_func());
#endif
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::bytesToWrite() == %i :socketp=%x", d->writeBuffer.size(),d_func());
#endif
...
#ifdef FJ_INSP_NETWORKLOG
	DEBUG_SOCKET_QDEBUG("QAbstractSocket::bytesAvailable() == %llu :socketp=%x", available,d_func());
#endif
    return available;
}
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::canReadLine() == %s, buffer size = %d, size = %d :socketp=%x", hasLine ? "true" : "false",
    	d_func()->buffer.size(), d_func()->buffer.size(), d_func());
#endif
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::setSocketDescriptor: socketp=%x, socketEngine=%x", d, d->socketEngine);
#endif
    if (!d->socketEngine) {
...
bool QAbstractSocket::waitForConnected(int msecs)
{
    Q_D(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::waitForConnected(%i) :socketp=%x", msecs,d_func());
#endif

    if (state() == ConnectedState) {
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG("QAbstractSocket::waitForConnected(%i) already connected :socketp=%x", msecs,d_func());
#endif
        return true;
    }
...
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG("QAbstractSocket::waitForConnected(%i) doing host name lookup :socketp=%x", msecs,d_func());
#endif
        QHostInfo::abortHostLookup(d->hostLookupId);
        d->hostLookupId = -1;
#ifndef QT_NO_BEARERMANAGEMENT
...
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG("QAbstractSocket::waitForConnected(%i) waiting %.2f secs for connection attempt #%i :socketp=%x",
        	msecs, timeout / 1000.0, attempt++,d_func());
#endif
        timedOut = false;
...
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::waitForConnected(%i) == %s :socketp=%x", msecs,
    	state() == ConnectedState ? "true" : "false",d_func());
#endif
    if (state() != ConnectedState)
        return false;
    if (wasPendingClose)
...
bool QAbstractSocket::waitForReadyRead(int msecs)
{
    Q_D(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
	DEBUG_SOCKET_QDEBUG("QAbstractSocket::waitForReadyRead(%i) :socketp=%x", msecs,d_func());
#endif
...
//        qWarning("QAbstractSocket::waitForReadyRead() is not allowed in UnconnectedState");
    ...
    do {
        ...
        if (!d->socketEngine->waitForReadOrWrite(&readyToRead, &readyToWrite, true, !d->writeBuffer.isEmpty(),
            ...
            setErrorString(d->socketEngine->errorString());
#ifdef FJ_INSP_NETWORKLOG
			DEBUG_SOCKET_QDEBUG("QAbstractSocket::waitForReadyRead(%i) failed (%i, %s) :socketp=%x",
				msecs, d->socketError, errorString().toLatin1().constData(),d_func());
#endif
            emit error(d->socketError);
...
bool QAbstractSocket::waitForBytesWritten(int msecs)
{
    Q_D(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
	DEBUG_SOCKET_QDEBUG("QAbstractSocket::waitForBytesWritten(%i) :socketp=%x", msecs,d_func());
#endif

    // require calling connectToHost() before waitForBytesWritten()
    if (state() == UnconnectedState) {
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::waitForBytesWritten() is not allowed in UnconnectedState");
#endif
        return false;
    }
    ...
    forever {
        ...
        if (!d->socketEngine->waitForReadOrWrite(&readyToRead, &readyToWrite, true, !d->writeBuffer.isEmpty(),
            ...
            setErrorString(d->socketEngine->errorString());
#ifdef FJ_INSP_NETWORKLOG
			DEBUG_SOCKET_QDEBUG("QAbstractSocket::waitForBytesWritten(%i) failed (%i, %s) :socketp=%x",
                   msecs, d->socketError, errorString().toLatin1().constData(),d_func());
#endif
            emit error(d->socketError);
            if (d->socketError != SocketTimeoutError)
        ...
        if (readyToRead) {
#ifdef FJ_INSP_NETWORKLOG
            DEBUG_SOCKET_QDEBUG("QAbstractSocket::waitForBytesWritten calls canReadNotification :socketp=%x",d_func());
#endif
            if(!d->canReadNotification())
                return false;
        }
...
#ifdef FJ_INSP_NETWORKLOG
				DEBUG_SOCKET_QDEBUG("QAbstractSocket::waitForBytesWritten returns true :socketp=%x",d_func());
#endif
                return true;
            }
        }
...
bool QAbstractSocket::waitForDisconnected(int msecs)
{
    ...
    if (state() == UnconnectedState) {
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::waitForDisconnected() is not allowed in UnconnectedState");
#endif
        return false;
    }
...
void QAbstractSocket::abort()
{
    Q_D(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
	DEBUG_SOCKET_QDEBUG("QAbstractSocket::abort() :socketp=%x",d_func());
#endif
    d->writeBuffer.clear();
    if (d->state == UnconnectedState)
        return;
...
#ifdef FJ_INSP_NETWORKLOG
	DEBUG_SOCKET_QDEBUG("QAbstractSocket::readData(%p \"%s\", %lli) == %lld [engine] :socketp=%x",
    	data, qt_prettyDebug(data, 32, readBytes).data(), maxSize, readBytes,d_func());
#endif
    return readBytes;
...
#ifdef FJ_INSP_NETWORKLOG
		DEBUG_SOCKET_QDEBUG("QAbstractSocket::writeData(%p \"%s\", %lli) == %lli :socketp=%x", 
			data, qt_prettyDebug(data, qMin((int)size, 32), size).data(), size, written,d_func());
#endif
        if (written >= 0)
...
void QAbstractSocket::close()
{
    Q_D(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::close() :socketp=%x",d_func());
#endif
    QIODevice::close();
    if (d->state != UnconnectedState) {
        d->closeCalled = true;
...
void QAbstractSocket::disconnectFromHost()
{
    Q_D(QAbstractSocket);
#ifdef FJ_INSP_NETWORKLOG
    DEBUG_SOCKET_QDEBUG("QAbstractSocket::disconnectFromHost() :socketp=%x",d_func());
#endif

    if (d->state == UnconnectedState) {
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG("QAbstractSocket::disconnectFromHost() was called on an unconnected socket :socketp=%x",d_func());
#endif
        return;
    }
...
#ifdef FJ_INSP_NETWORKLOG
		DEBUG_SOCKET_QDEBUG("QAbstractSocket::disconnectFromHost() but we're still connecting :socketp=%x",d_func());
#endif
        d->pendingClose = true;
        return;
    }
    ...
    if (d->abortCalled) {
#ifdef FJ_INSP_NETWORKLOG
		DEBUG_SOCKET_QDEBUG("QAbstractSocket::disconnectFromHost() aborting immediately :socketp=%x",d_func());
#endif
        if (d->state == HostLookupState) {
            QHostInfo::abortHostLookup(d->hostLookupId);
            d->hostLookupId = -1;
...
#ifdef FJ_INSP_NETWORKLOG
			DEBUG_SOCKET_QDEBUG("QAbstractSocket::disconnectFromHost() emits stateChanged()(ClosingState) :socketp=%x",d_func());
#endif
            emit stateChanged(d->state);
        } else {
#ifdef FJ_INSP_NETWORKLOG
			DEBUG_SOCKET_QDEBUG("QAbstractSocket::disconnectFromHost() return from delayed close :socketp=%x",d_func());
#endif
        }
...
#ifdef FJ_INSP_NETWORKLOG
			DEBUG_SOCKET_QDEBUG("QAbstractSocket::disconnectFromHost() delaying disconnect :socketp=%x",d_func());
#endif
            return;
        } else {
#ifdef FJ_INSP_NETWORKLOG
			DEBUG_SOCKET_QDEBUG("QAbstractSocket::disconnectFromHost() disconnecting immediately :socketp=%x",d_func());
#endif
        }
    }
...
#ifdef FJ_INSP_NETWORKLOG
	DEBUG_SOCKET_QDEBUG("QAbstractSocket::disconnectFromHost() disconnected! :socketp=%x",d_func());
#endif

    if (d->closeCalled) {
#ifdef FJ_INSP_NETWORKLOG
		DEBUG_SOCKET_QDEBUG("QAbstractSocket::disconnectFromHost() closed! :socketp=%x",d_func());
#endif
        d->buffer.clear();
        d->writeBuffer.clear();
        QIODevice::close();
...
Q_NETWORK_EXPORT QDebug operator<<(QDebug debug, QAbstractSocket::SocketError error)
{
    ...
    case QAbstractSocket::ConnectionRefusedError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::ConnectionRefusedError");
        break;
    case QAbstractSocket::RemoteHostClosedError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::RemoteHostClosedError");
        break;
    case QAbstractSocket::HostNotFoundError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::HostNotFoundError");
        break;
    case QAbstractSocket::SocketAccessError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::SocketAccessError");
        break;
    case QAbstractSocket::SocketResourceError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::SocketResourceError");
        break;
    case QAbstractSocket::SocketTimeoutError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::SocketTimeoutError");
        break;
    case QAbstractSocket::DatagramTooLargeError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::DatagramTooLargeError");
        break;
    case QAbstractSocket::NetworkError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::NetworkError");
        break;
    case QAbstractSocket::AddressInUseError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::AddressInUseError");
        break;
    case QAbstractSocket::SocketAddressNotAvailableError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::SocketAddressNotAvailableError");
        break;
    case QAbstractSocket::UnsupportedSocketOperationError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::UnsupportedSocketOperationError");
        break;
    case QAbstractSocket::UnfinishedSocketOperationError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::UnfinishedSocketOperationError");
        break;
    case QAbstractSocket::ProxyAuthenticationRequiredError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::ProxyAuthenticationRequiredError");
        break;
    case QAbstractSocket::UnknownSocketError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::UnknownSocketError");
        break;
    case QAbstractSocket::ProxyConnectionRefusedError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::ProxyConnectionRefusedError");
        break;
    case QAbstractSocket::ProxyConnectionClosedError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::ProxyConnectionClosedError");
        break;
    case QAbstractSocket::ProxyConnectionTimeoutError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::ProxyConnectionTimeoutError");
        break;
    case QAbstractSocket::ProxyNotFoundError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::ProxyNotFoundError");
        break;
    case QAbstractSocket::ProxyProtocolError:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::ProxyProtocolError");
        break;
    default:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::SocketError(%d)", int(error));
        break;
    }
#endif
    return debug;
...
Q_NETWORK_EXPORT QDebug operator<<(QDebug debug, QAbstractSocket::SocketState state)
{
    ...
    case QAbstractSocket::UnconnectedState:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::UnconnectedState");
        break;
    case QAbstractSocket::HostLookupState:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::HostLookupState");
        break;
    case QAbstractSocket::ConnectingState:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::ConnectingState");
        break;
    case QAbstractSocket::ConnectedState:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::ConnectedState");
        break;
    case QAbstractSocket::BoundState:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::BoundState");
        break;
    case QAbstractSocket::ListeningState:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::ListeningState");
        break;
    case QAbstractSocket::ClosingState:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::ClosingState");
        break;
    default:
        DEBUG_SOCKET_QDEBUG2("QAbstractSocket::SocketState(%d)", int(state));
        break;
    }
#endif
    return debug;
