...
void QLocalSocketPrivate::_q_stateChanged(QAbstractSocket::SocketState newState)
{
    ...
    default:
        ...
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::Unhandled socket state change:%d", newState);
#endif
        return;
    }
...
QLocalSocket::LocalSocketError QLocalSocket::error() const
{
    ...
    default:
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG2("QLocalSocket error not handled:%d", d->unixSocket.error());
#endif
        break;
    }
...
#ifdef FJ_INSP_NETWORKLOG
        DEBUG_SOCKET_QDEBUG2("QLocalSocket::waitForDisconnected() is not allowed in UnconnectedState");
#endif
        return false;
    }
