...
#define STR_SYSTEM "aarch64-unknown-nto-qnx7.0.0"
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/tags/7.0.0/GA/lib/io-pkt/dist/ntp/nto-aarch64-le/sntp/config.h $ $Rev: 806186 $")
#endif
