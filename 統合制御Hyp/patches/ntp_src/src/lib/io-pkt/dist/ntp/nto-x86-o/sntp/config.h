...
#define STR_SYSTEM "i586-pc-nto-qnx7.0.0"
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/tags/7.0.0/GA/lib/io-pkt/dist/ntp/nto-x86-o/sntp/config.h $ $Rev: 806186 $")
#endif
