...
#define SRCDIR_DEF "/tmp/ntp-4.2.8p8/nto-arm-le-v7/sntp/../../sntp/tests/data/";
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/tags/7.0.0/GA/lib/io-pkt/dist/ntp/nto-arm-le-v7/sntp/tests/fileHandlingTest.h $ $Rev: 806186 $")
#endif
