...
#include "elvis.h"
#ifdef FEATURE_RCSID
char id_cut[] = "$Id: cut.c 680331 2012-11-27 01:22:57Z builder@qnx.com $";
#endif
...
__SRCVERSION("$URL: http://svn/product/branches/7.0.0/trunk/utils/e/elvis/elvis/cut.c $ $Rev: 680331 $")
#endif
