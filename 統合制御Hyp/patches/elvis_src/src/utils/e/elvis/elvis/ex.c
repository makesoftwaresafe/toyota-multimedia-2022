...
#include "elvis.h"
#ifdef FEATURE_RCSID
char id_ex[] = "$Id: ex.c 680331 2012-11-27 01:22:57Z builder@qnx.com $";
#endif
...
__SRCVERSION("$URL: http://svn/product/branches/7.0.0/trunk/utils/e/elvis/elvis/ex.c $ $Rev: 680331 $")
#endif
