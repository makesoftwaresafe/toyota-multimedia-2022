 ...
 * 2008-06-17 - When progname is 'view' set defaultreadonly
 * 2008-04-24 - When progname is 'ex' start in ex mode
 *
...
#include "elvis.h"
#ifdef FEATURE_RCSID
char id_main[] = "$Id: main.c 680331 2012-11-27 01:22:57Z builder@qnx.com $";
#endif
...
__SRCVERSION("$URL: http://svn/product/branches/7.0.0/trunk/utils/e/elvis/elvis/main.c $ $Rev: 680331 $")
#endif
